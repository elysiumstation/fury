...
type RootCmd struct {
	...
	Import   importCmd   `command:"import" description:"Import the configuration of a wallet required by the fury node"`
...
func NodeWallet(ctx context.Context, parser *flags.Parser) error {
	...
	var (
		...
		long  = `The nodewallet is a wallet owned by the fury node, it contains all
	the information to login to other wallets from external blockchain that
	fury will need to run properly (e.g and ethereum wallet, which allow fury
