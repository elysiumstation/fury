...
func (e *ERC20Cmd) GetSigner() (bridges.Signer, error) {
	furyPaths := paths.New(e.FuryHome)
	...
	if len(e.PrivateKey) <= 0 {
		...
		s, err = nodewallets.GetEthereumWallet(furyPaths, pass)
		if err != nil {
...
type ERC20ListAssetCmd struct {
	TokenAddress      string `long:"token-address" required:"true" description:"The Ethereum address of the new token"`
	FuryAssetID       string `long:"fury-asset-id" required:"true" description:"The fury ID for this new token"`
	BridgeAddress     string `long:"bridge-address" required:"true" description:"The address of the fury bridge this transaction will be submitted to"`
	Nonce             string `long:"nonce" required:"true" description:"A nonce for this signature"`
...
func (opts *ERC20ListAssetCmd) Execute(_ []string) error {
	...
	bundle, err := erc20Logic.ListAsset(
		opts.TokenAddress, opts.FuryAssetID, lifetimeLimit, withdrawThreshod, nonce,
	)
	if err != nil {
		return fmt.Errorf("unable to generate signature: %w", err)
	}
...
type ERC20SetBridgeAddressCmd struct {
	...
	AssetPoolAddress string `long:"asset-pool-address" required:"true" description:"The address of the fury asset pool this transaction will be submitted to"`
	Nonce            string `long:"nonce" required:"true" description:"A nonce for this signature"`
}
