...
import (
	...
	"github.com/elysiumstation/fury/core/api/rest"
	...
	"github.com/elysiumstation/fury/core/protocol"
...
func (n *Command) Run(
	...
	n.protocol, err = protocol.New(
		n.ctx, n.confWatcher, n.Log, n.cancel, n.stopBlockchain, n.nodeWallets, n.ethClient, n.ethConfirmations, n.blockchainClient, furyPaths, n.stats)
	if err != nil {
		return err
	}
	...
	n.Log.Info("Fury startup complete",
...
func (n *Command) Stop() error {
	...
	n.Log.Info("Fury shutdown complete",
		logging.String("version", version.Get()),
...
func (n *Command) startAPIs() error {
	...
	if n.conf.IsValidator() {
		adminServer, err := admin.NewValidatorServer(n.Log, n.conf.Admin, n.furyPaths, n.nodeWalletPassphrase, n.nodeWallets, n.protocol.GetProtocolUpgradeService())
		if err != nil {
			return err
		}
...
func (n *Command) setupCommon() (err error) {
	...
	if conf.Pprof.Enabled {
		n.Log.Info("fury is starting with pprof profile, this is not a recommended setting for production")
...
func (n *Command) loadNodeWallets() (err error) {
	...
	n.nodeWallets, err = nodewallets.GetNodeWallets(n.conf.NodeWallet, n.furyPaths, n.nodeWalletPassphrase)
	if err != nil {
