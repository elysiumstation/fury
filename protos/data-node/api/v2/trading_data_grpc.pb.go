...
func (c *tradingDataServiceClient) GetFuryTime(ctx context.Context, in *GetFuryTimeRequest, opts ...grpc.CallOption) (*GetFuryTimeResponse, error) {
	out := new(GetFuryTimeResponse)
	err := c.cc.Invoke(ctx, "/datanode.api.v2.TradingDataService/GetFuryTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTradingDataServiceServer) GetFuryTime(context.Context, *GetFuryTimeRequest) (*GetFuryTimeResponse, error) {
...
func _TradingDataService_GetFuryTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFuryTimeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TradingDataServiceServer).GetFuryTime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/datanode.api.v2.TradingDataService/GetFuryTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TradingDataServiceServer).GetFuryTime(ctx, req.(*GetFuryTimeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
