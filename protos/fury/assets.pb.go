...
func (Asset_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_fury_assets_proto_enumTypes[0].Descriptor()
}

func (Asset_Status) Type() protoreflect.EnumType {
	return &file_fury_assets_proto_enumTypes[0]
}
...
func (Asset_Status) EnumDescriptor() ([]byte, []int) {
	return file_fury_assets_proto_rawDescGZIP(), []int{0, 0}
}

// Fury representation of an external asset
type Asset struct {
	...
	// Status of the asset.
	Status Asset_Status `protobuf:"varint,3,opt,name=status,proto3,enum=fury.Asset_Status" json:"status,omitempty"`
}

func (x *Asset) Reset() {
	*x = Asset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_assets_proto_msgTypes[0]
...
func (*Asset) Descriptor() ([]byte, []int) {
	return file_fury_assets_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetDetails) Reset() {
	*x = AssetDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_assets_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetDetails) Descriptor() ([]byte, []int) {
	return file_fury_assets_proto_rawDescGZIP(), []int{1}
}
...
func (x *BuiltinAsset) Reset() {
	*x = BuiltinAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_assets_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BuiltinAsset) Descriptor() ([]byte, []int) {
	return file_fury_assets_proto_rawDescGZIP(), []int{2}
}
...
func (x *ERC20) Reset() {
	*x = ERC20{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_assets_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ERC20) Descriptor() ([]byte, []int) {
	return file_fury_assets_proto_rawDescGZIP(), []int{3}
}
...
func (x *AssetDetailsUpdate) Reset() {
	*x = AssetDetailsUpdate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_assets_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetDetailsUpdate) Descriptor() ([]byte, []int) {
	return file_fury_assets_proto_rawDescGZIP(), []int{4}
}
...
func (x *ERC20Update) Reset() {
	*x = ERC20Update{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_assets_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ERC20Update) Descriptor() ([]byte, []int) {
	return file_fury_assets_proto_rawDescGZIP(), []int{5}
}
...
var File_fury_assets_proto protoreflect.FileDescriptor

var file_fury_assets_proto_rawDesc = []byte{
...
var (
	file_fury_assets_proto_rawDescOnce sync.Once
	file_fury_assets_proto_rawDescData = file_fury_assets_proto_rawDesc
)

func file_fury_assets_proto_rawDescGZIP() []byte {
	file_fury_assets_proto_rawDescOnce.Do(func() {
		file_fury_assets_proto_rawDescData = protoimpl.X.CompressGZIP(file_fury_assets_proto_rawDescData)
	})
	return file_fury_assets_proto_rawDescData
}

var file_fury_assets_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_fury_assets_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_fury_assets_proto_goTypes = []interface{}{
	(Asset_Status)(0),          // 0: fury.Asset.Status
	(*Asset)(nil),              // 1: fury.Asset
	(*AssetDetails)(nil),       // 2: fury.AssetDetails
	(*BuiltinAsset)(nil),       // 3: fury.BuiltinAsset
	(*ERC20)(nil),              // 4: fury.ERC20
	(*AssetDetailsUpdate)(nil), // 5: fury.AssetDetailsUpdate
	(*ERC20Update)(nil),        // 6: fury.ERC20Update
}
var file_fury_assets_proto_depIdxs = []int32{
	2, // 0: fury.Asset.details:type_name -> fury.AssetDetails
	0, // 1: fury.Asset.status:type_name -> fury.Asset.Status
	3, // 2: fury.AssetDetails.builtin_asset:type_name -> fury.BuiltinAsset
	4, // 3: fury.AssetDetails.erc20:type_name -> fury.ERC20
	6, // 4: fury.AssetDetailsUpdate.erc20:type_name -> fury.ERC20Update
...
func init() { file_fury_assets_proto_init() }
func file_fury_assets_proto_init() {
	if File_fury_assets_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_fury_assets_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Asset); i {
			case 0:
				return &v.state
			case 1:
		...
		file_fury_assets_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fury_assets_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fury_assets_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ERC20); i {
			case 0:
				return &v.state
			case 1:
		...
		file_fury_assets_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fury_assets_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_fury_assets_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*AssetDetails_BuiltinAsset)(nil),
		(*AssetDetails_Erc20)(nil),
	}
	file_fury_assets_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fury_assets_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fury_assets_proto_goTypes,
		DependencyIndexes: file_fury_assets_proto_depIdxs,
		EnumInfos:         file_fury_assets_proto_enumTypes,
		MessageInfos:      file_fury_assets_proto_msgTypes,
	}.Build()
	File_fury_assets_proto = out.File
	file_fury_assets_proto_rawDesc = nil
	file_fury_assets_proto_goTypes = nil
	file_fury_assets_proto_depIdxs = nil
}
