...
// 	protoc        (unknown)
// source: fury/wallet/v1/wallet.proto
...
func (x *SubmitTransactionRequest) Reset() {
	*x = SubmitTransactionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_wallet_v1_wallet_proto_msgTypes[0]
...
func (*SubmitTransactionRequest) Descriptor() ([]byte, []int) {
	return file_fury_wallet_v1_wallet_proto_rawDescGZIP(), []int{0}
}
...
var File_fury_wallet_v1_wallet_proto protoreflect.FileDescriptor

var file_fury_wallet_v1_wallet_proto_rawDesc = []byte{
...
var (
	file_fury_wallet_v1_wallet_proto_rawDescOnce sync.Once
	file_fury_wallet_v1_wallet_proto_rawDescData = file_fury_wallet_v1_wallet_proto_rawDesc
)

func file_fury_wallet_v1_wallet_proto_rawDescGZIP() []byte {
	file_fury_wallet_v1_wallet_proto_rawDescOnce.Do(func() {
		file_fury_wallet_v1_wallet_proto_rawDescData = protoimpl.X.CompressGZIP(file_fury_wallet_v1_wallet_proto_rawDescData)
	})
	return file_fury_wallet_v1_wallet_proto_rawDescData
}

var file_fury_wallet_v1_wallet_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_fury_wallet_v1_wallet_proto_goTypes = []interface{}{
	(*SubmitTransactionRequest)(nil),          // 0: fury.wallet.v1.SubmitTransactionRequest
	(*v1.OrderSubmission)(nil),                // 1: fury.commands.v1.OrderSubmission
	(*v1.OrderCancellation)(nil),              // 2: fury.commands.v1.OrderCancellation
	(*v1.OrderAmendment)(nil),                 // 3: fury.commands.v1.OrderAmendment
	(*v1.WithdrawSubmission)(nil),             // 4: fury.commands.v1.WithdrawSubmission
	(*v1.ProposalSubmission)(nil),             // 5: fury.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                 // 6: fury.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),   // 7: fury.commands.v1.LiquidityProvisionSubmission
	(*v1.DelegateSubmission)(nil),             // 8: fury.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),           // 9: fury.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil), // 10: fury.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),    // 11: fury.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                       // 12: fury.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                 // 13: fury.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                   // 14: fury.commands.v1.AnnounceNode
	(*v1.BatchMarketInstructions)(nil),        // 15: fury.commands.v1.BatchMarketInstructions
	(*v1.NodeVote)(nil),                       // 16: fury.commands.v1.NodeVote
	(*v1.NodeSignature)(nil),                  // 17: fury.commands.v1.NodeSignature
	(*v1.ChainEvent)(nil),                     // 18: fury.commands.v1.ChainEvent
	(*v1.KeyRotateSubmission)(nil),            // 19: fury.commands.v1.KeyRotateSubmission
	(*v1.StateVariableProposal)(nil),          // 20: fury.commands.v1.StateVariableProposal
	(*v1.ValidatorHeartbeat)(nil),             // 21: fury.commands.v1.ValidatorHeartbeat
	(*v1.EthereumKeyRotateSubmission)(nil),    // 22: fury.commands.v1.EthereumKeyRotateSubmission
	(*v1.ProtocolUpgradeProposal)(nil),        // 23: fury.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                // 24: fury.commands.v1.IssueSignatures
	(*v1.OracleDataSubmission)(nil),           // 25: fury.commands.v1.OracleDataSubmission
}
var file_fury_wallet_v1_wallet_proto_depIdxs = []int32{
	1,  // 0: fury.wallet.v1.SubmitTransactionRequest.order_submission:type_name -> fury.commands.v1.OrderSubmission
	2,  // 1: fury.wallet.v1.SubmitTransactionRequest.order_cancellation:type_name -> fury.commands.v1.OrderCancellation
	3,  // 2: fury.wallet.v1.SubmitTransactionRequest.order_amendment:type_name -> fury.commands.v1.OrderAmendment
	4,  // 3: fury.wallet.v1.SubmitTransactionRequest.withdraw_submission:type_name -> fury.commands.v1.WithdrawSubmission
	5,  // 4: fury.wallet.v1.SubmitTransactionRequest.proposal_submission:type_name -> fury.commands.v1.ProposalSubmission
	6,  // 5: fury.wallet.v1.SubmitTransactionRequest.vote_submission:type_name -> fury.commands.v1.VoteSubmission
	7,  // 6: fury.wallet.v1.SubmitTransactionRequest.liquidity_provision_submission:type_name -> fury.commands.v1.LiquidityProvisionSubmission
	8,  // 7: fury.wallet.v1.SubmitTransactionRequest.delegate_submission:type_name -> fury.commands.v1.DelegateSubmission
	9,  // 8: fury.wallet.v1.SubmitTransactionRequest.undelegate_submission:type_name -> fury.commands.v1.UndelegateSubmission
	10, // 9: fury.wallet.v1.SubmitTransactionRequest.liquidity_provision_cancellation:type_name -> fury.commands.v1.LiquidityProvisionCancellation
	11, // 10: fury.wallet.v1.SubmitTransactionRequest.liquidity_provision_amendment:type_name -> fury.commands.v1.LiquidityProvisionAmendment
	12, // 11: fury.wallet.v1.SubmitTransactionRequest.transfer:type_name -> fury.commands.v1.Transfer
	13, // 12: fury.wallet.v1.SubmitTransactionRequest.cancel_transfer:type_name -> fury.commands.v1.CancelTransfer
	14, // 13: fury.wallet.v1.SubmitTransactionRequest.announce_node:type_name -> fury.commands.v1.AnnounceNode
	15, // 14: fury.wallet.v1.SubmitTransactionRequest.batch_market_instructions:type_name -> fury.commands.v1.BatchMarketInstructions
	16, // 15: fury.wallet.v1.SubmitTransactionRequest.node_vote:type_name -> fury.commands.v1.NodeVote
	17, // 16: fury.wallet.v1.SubmitTransactionRequest.node_signature:type_name -> fury.commands.v1.NodeSignature
	18, // 17: fury.wallet.v1.SubmitTransactionRequest.chain_event:type_name -> fury.commands.v1.ChainEvent
	19, // 18: fury.wallet.v1.SubmitTransactionRequest.key_rotate_submission:type_name -> fury.commands.v1.KeyRotateSubmission
	20, // 19: fury.wallet.v1.SubmitTransactionRequest.state_variable_proposal:type_name -> fury.commands.v1.StateVariableProposal
	21, // 20: fury.wallet.v1.SubmitTransactionRequest.validator_heartbeat:type_name -> fury.commands.v1.ValidatorHeartbeat
	22, // 21: fury.wallet.v1.SubmitTransactionRequest.ethereum_key_rotate_submission:type_name -> fury.commands.v1.EthereumKeyRotateSubmission
	23, // 22: fury.wallet.v1.SubmitTransactionRequest.protocol_upgrade_proposal:type_name -> fury.commands.v1.ProtocolUpgradeProposal
	24, // 23: fury.wallet.v1.SubmitTransactionRequest.issue_signatures:type_name -> fury.commands.v1.IssueSignatures
	25, // 24: fury.wallet.v1.SubmitTransactionRequest.oracle_data_submission:type_name -> fury.commands.v1.OracleDataSubmission
...
func init() { file_fury_wallet_v1_wallet_proto_init() }
func file_fury_wallet_v1_wallet_proto_init() {
	if File_fury_wallet_v1_wallet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_fury_wallet_v1_wallet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_fury_wallet_v1_wallet_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fury_wallet_v1_wallet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fury_wallet_v1_wallet_proto_goTypes,
		DependencyIndexes: file_fury_wallet_v1_wallet_proto_depIdxs,
		MessageInfos:      file_fury_wallet_v1_wallet_proto_msgTypes,
	}.Build()
	File_fury_wallet_v1_wallet_proto = out.File
	file_fury_wallet_v1_wallet_proto_rawDesc = nil
	file_fury_wallet_v1_wallet_proto_goTypes = nil
	file_fury_wallet_v1_wallet_proto_depIdxs = nil
}
