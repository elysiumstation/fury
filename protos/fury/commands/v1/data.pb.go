...
// 	protoc        (unknown)
// source: fury/commands/v1/data.proto
...
func (OracleDataSubmission_OracleSource) Descriptor() protoreflect.EnumDescriptor {
	return file_fury_commands_v1_data_proto_enumTypes[0].Descriptor()
}

func (OracleDataSubmission_OracleSource) Type() protoreflect.EnumType {
	return &file_fury_commands_v1_data_proto_enumTypes[0]
}
...
func (OracleDataSubmission_OracleSource) EnumDescriptor() ([]byte, []int) {
	return file_fury_commands_v1_data_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *OracleDataSubmission) Reset() {
	*x = OracleDataSubmission{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_commands_v1_data_proto_msgTypes[0]
...
func (*OracleDataSubmission) Descriptor() ([]byte, []int) {
	return file_fury_commands_v1_data_proto_rawDescGZIP(), []int{0}
}
...
var file_fury_commands_v1_data_proto_rawDesc = []byte{
...
var (
	file_fury_commands_v1_data_proto_rawDescOnce sync.Once
	file_fury_commands_v1_data_proto_rawDescData = file_fury_commands_v1_data_proto_rawDesc
)

func file_fury_commands_v1_data_proto_rawDescGZIP() []byte {
	file_fury_commands_v1_data_proto_rawDescOnce.Do(func() {
		file_fury_commands_v1_data_proto_rawDescData = protoimpl.X.CompressGZIP(file_fury_commands_v1_data_proto_rawDescData)
	})
	return file_fury_commands_v1_data_proto_rawDescData
}

var file_fury_commands_v1_data_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_fury_commands_v1_data_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_fury_commands_v1_data_proto_goTypes = []interface{}{
	(OracleDataSubmission_OracleSource)(0), // 0: fury.commands.v1.OracleDataSubmission.OracleSource
	(*OracleDataSubmission)(nil),           // 1: fury.commands.v1.OracleDataSubmission
}
var file_fury_commands_v1_data_proto_depIdxs = []int32{
	0, // 0: fury.commands.v1.OracleDataSubmission.source:type_name -> fury.commands.v1.OracleDataSubmission.OracleSource
...
func init() { file_fury_commands_v1_data_proto_init() }
func file_fury_commands_v1_data_proto_init() {
	if File_fury_commands_v1_data_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_fury_commands_v1_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fury_commands_v1_data_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fury_commands_v1_data_proto_goTypes,
		DependencyIndexes: file_fury_commands_v1_data_proto_depIdxs,
		EnumInfos:         file_fury_commands_v1_data_proto_enumTypes,
		MessageInfos:      file_fury_commands_v1_data_proto_msgTypes,
	}.Build()
	File_fury_commands_v1_data_proto = out.File
	file_fury_commands_v1_data_proto_rawDesc = nil
	file_fury_commands_v1_data_proto_goTypes = nil
	file_fury_commands_v1_data_proto_depIdxs = nil
}
