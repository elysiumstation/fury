...
// 	protoc        (unknown)
// source: fury/commands/v1/transaction.proto
...
func (TxVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_fury_commands_v1_transaction_proto_enumTypes[0].Descriptor()
}

func (TxVersion) Type() protoreflect.EnumType {
	return &file_fury_commands_v1_transaction_proto_enumTypes[0]
}
...
func (TxVersion) EnumDescriptor() ([]byte, []int) {
	return file_fury_commands_v1_transaction_proto_rawDescGZIP(), []int{0}
}
...
func (x *InputData) Reset() {
	*x = InputData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_commands_v1_transaction_proto_msgTypes[0]
...
func (x *Transaction) Reset() {
	*x = Transaction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_commands_v1_transaction_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return file_fury_commands_v1_transaction_proto_rawDescGZIP(), []int{1}
}
...
func (x *ProofOfWork) Reset() {
	*x = ProofOfWork{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fury_commands_v1_transaction_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProofOfWork) Descriptor() ([]byte, []int) {
	return file_fury_commands_v1_transaction_proto_rawDescGZIP(), []int{2}
}
...
var file_fury_commands_v1_transaction_proto_rawDesc = []byte{
...
var (
	file_fury_commands_v1_transaction_proto_rawDescOnce sync.Once
	file_fury_commands_v1_transaction_proto_rawDescData = file_fury_commands_v1_transaction_proto_rawDesc
)

func file_fury_commands_v1_transaction_proto_rawDescGZIP() []byte {
	file_fury_commands_v1_transaction_proto_rawDescOnce.Do(func() {
		file_fury_commands_v1_transaction_proto_rawDescData = protoimpl.X.CompressGZIP(file_fury_commands_v1_transaction_proto_rawDescData)
	})
	return file_fury_commands_v1_transaction_proto_rawDescData
}

var file_fury_commands_v1_transaction_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_fury_commands_v1_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_fury_commands_v1_transaction_proto_goTypes = []interface{}{
	(TxVersion)(0),                         // 0: fury.commands.v1.TxVersion
	(*InputData)(nil),                      // 1: fury.commands.v1.InputData
	(*Transaction)(nil),                    // 2: fury.commands.v1.Transaction
	(*ProofOfWork)(nil),                    // 3: fury.commands.v1.ProofOfWork
	(*OrderSubmission)(nil),                // 4: fury.commands.v1.OrderSubmission
	(*OrderCancellation)(nil),              // 5: fury.commands.v1.OrderCancellation
	(*OrderAmendment)(nil),                 // 6: fury.commands.v1.OrderAmendment
	(*WithdrawSubmission)(nil),             // 7: fury.commands.v1.WithdrawSubmission
	(*ProposalSubmission)(nil),             // 8: fury.commands.v1.ProposalSubmission
	(*VoteSubmission)(nil),                 // 9: fury.commands.v1.VoteSubmission
	(*LiquidityProvisionSubmission)(nil),   // 10: fury.commands.v1.LiquidityProvisionSubmission
	(*DelegateSubmission)(nil),             // 11: fury.commands.v1.DelegateSubmission
	(*UndelegateSubmission)(nil),           // 12: fury.commands.v1.UndelegateSubmission
	(*LiquidityProvisionCancellation)(nil), // 13: fury.commands.v1.LiquidityProvisionCancellation
	(*LiquidityProvisionAmendment)(nil),    // 14: fury.commands.v1.LiquidityProvisionAmendment
	(*Transfer)(nil),                       // 15: fury.commands.v1.Transfer
	(*CancelTransfer)(nil),                 // 16: fury.commands.v1.CancelTransfer
	(*AnnounceNode)(nil),                   // 17: fury.commands.v1.AnnounceNode
	(*BatchMarketInstructions)(nil),        // 18: fury.commands.v1.BatchMarketInstructions
	(*NodeVote)(nil),                       // 19: fury.commands.v1.NodeVote
	(*NodeSignature)(nil),                  // 20: fury.commands.v1.NodeSignature
	(*ChainEvent)(nil),                     // 21: fury.commands.v1.ChainEvent
	(*KeyRotateSubmission)(nil),            // 22: fury.commands.v1.KeyRotateSubmission
	(*StateVariableProposal)(nil),          // 23: fury.commands.v1.StateVariableProposal
	(*ValidatorHeartbeat)(nil),             // 24: fury.commands.v1.ValidatorHeartbeat
	(*EthereumKeyRotateSubmission)(nil),    // 25: fury.commands.v1.EthereumKeyRotateSubmission
	(*ProtocolUpgradeProposal)(nil),        // 26: fury.commands.v1.ProtocolUpgradeProposal
	(*IssueSignatures)(nil),                // 27: fury.commands.v1.IssueSignatures
	(*OracleDataSubmission)(nil),           // 28: fury.commands.v1.OracleDataSubmission
	(*Signature)(nil),                      // 29: fury.commands.v1.Signature
}
var file_fury_commands_v1_transaction_proto_depIdxs = []int32{
	4,  // 0: fury.commands.v1.InputData.order_submission:type_name -> fury.commands.v1.OrderSubmission
	5,  // 1: fury.commands.v1.InputData.order_cancellation:type_name -> fury.commands.v1.OrderCancellation
	6,  // 2: fury.commands.v1.InputData.order_amendment:type_name -> fury.commands.v1.OrderAmendment
	7,  // 3: fury.commands.v1.InputData.withdraw_submission:type_name -> fury.commands.v1.WithdrawSubmission
	8,  // 4: fury.commands.v1.InputData.proposal_submission:type_name -> fury.commands.v1.ProposalSubmission
	9,  // 5: fury.commands.v1.InputData.vote_submission:type_name -> fury.commands.v1.VoteSubmission
	10, // 6: fury.commands.v1.InputData.liquidity_provision_submission:type_name -> fury.commands.v1.LiquidityProvisionSubmission
	11, // 7: fury.commands.v1.InputData.delegate_submission:type_name -> fury.commands.v1.DelegateSubmission
	12, // 8: fury.commands.v1.InputData.undelegate_submission:type_name -> fury.commands.v1.UndelegateSubmission
	13, // 9: fury.commands.v1.InputData.liquidity_provision_cancellation:type_name -> fury.commands.v1.LiquidityProvisionCancellation
	14, // 10: fury.commands.v1.InputData.liquidity_provision_amendment:type_name -> fury.commands.v1.LiquidityProvisionAmendment
	15, // 11: fury.commands.v1.InputData.transfer:type_name -> fury.commands.v1.Transfer
	16, // 12: fury.commands.v1.InputData.cancel_transfer:type_name -> fury.commands.v1.CancelTransfer
	17, // 13: fury.commands.v1.InputData.announce_node:type_name -> fury.commands.v1.AnnounceNode
	18, // 14: fury.commands.v1.InputData.batch_market_instructions:type_name -> fury.commands.v1.BatchMarketInstructions
	19, // 15: fury.commands.v1.InputData.node_vote:type_name -> fury.commands.v1.NodeVote
	20, // 16: fury.commands.v1.InputData.node_signature:type_name -> fury.commands.v1.NodeSignature
	21, // 17: fury.commands.v1.InputData.chain_event:type_name -> fury.commands.v1.ChainEvent
	22, // 18: fury.commands.v1.InputData.key_rotate_submission:type_name -> fury.commands.v1.KeyRotateSubmission
	23, // 19: fury.commands.v1.InputData.state_variable_proposal:type_name -> fury.commands.v1.StateVariableProposal
	24, // 20: fury.commands.v1.InputData.validator_heartbeat:type_name -> fury.commands.v1.ValidatorHeartbeat
	25, // 21: fury.commands.v1.InputData.ethereum_key_rotate_submission:type_name -> fury.commands.v1.EthereumKeyRotateSubmission
	26, // 22: fury.commands.v1.InputData.protocol_upgrade_proposal:type_name -> fury.commands.v1.ProtocolUpgradeProposal
	27, // 23: fury.commands.v1.InputData.issue_signatures:type_name -> fury.commands.v1.IssueSignatures
	28, // 24: fury.commands.v1.InputData.oracle_data_submission:type_name -> fury.commands.v1.OracleDataSubmission
	29, // 25: fury.commands.v1.Transaction.signature:type_name -> fury.commands.v1.Signature
	0,  // 26: fury.commands.v1.Transaction.version:type_name -> fury.commands.v1.TxVersion
	3,  // 27: fury.commands.v1.Transaction.pow:type_name -> fury.commands.v1.ProofOfWork
...
func init() { file_fury_commands_v1_transaction_proto_init() }
func file_fury_commands_v1_transaction_proto_init() {
	if File_fury_commands_v1_transaction_proto != nil {
		return
	}
	file_fury_commands_v1_commands_proto_init()
	file_fury_commands_v1_data_proto_init()
	file_fury_commands_v1_signature_proto_init()
	file_fury_commands_v1_validator_commands_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_fury_commands_v1_transaction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fury_commands_v1_transaction_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fury_commands_v1_transaction_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_fury_commands_v1_transaction_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_fury_commands_v1_transaction_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fury_commands_v1_transaction_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fury_commands_v1_transaction_proto_goTypes,
		DependencyIndexes: file_fury_commands_v1_transaction_proto_depIdxs,
		EnumInfos:         file_fury_commands_v1_transaction_proto_enumTypes,
		MessageInfos:      file_fury_commands_v1_transaction_proto_msgTypes,
	}.Build()
	File_fury_commands_v1_transaction_proto = out.File
	file_fury_commands_v1_transaction_proto_rawDesc = nil
	file_fury_commands_v1_transaction_proto_goTypes = nil
	file_fury_commands_v1_transaction_proto_depIdxs = nil
}
