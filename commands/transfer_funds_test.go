...
func TestTransferFunds(t *testing.T) {
	cases := []struct {
		...
		{
			transfer: commandspb.Transfer{
				FromAccountType: fury.AccountType_ACCOUNT_TYPE_GENERAL,
				ToAccountType:   fury.AccountType_ACCOUNT_TYPE_GENERAL,
		...
		{
			transfer: commandspb.Transfer{
				FromAccountType: fury.AccountType_ACCOUNT_TYPE_MARGIN,
				ToAccountType:   fury.AccountType_ACCOUNT_TYPE_GENERAL,
				Kind: &commandspb.Transfer_OneOff{
					OneOff: &commandspb.OneOffTransfer{},
				},
		...
		},
		{
			transfer: commandspb.Transfer{
				FromAccountType: fury.AccountType_ACCOUNT_TYPE_GENERAL,
				ToAccountType:   fury.AccountType_ACCOUNT_TYPE_REWARD_LP_RECEIVED_FEES,
				Kind: &commandspb.Transfer_OneOff{
					OneOff: &commandspb.OneOffTransfer{},
				},
				To:        "84e2b15102a8d6c1c6b4bdf40af8a0dc21b040eaaa1c94cd10d17604b75fdc35",
		...
		},
		{
			transfer: commandspb.Transfer{
				FromAccountType: fury.AccountType_ACCOUNT_TYPE_GENERAL,
				ToAccountType:   fury.AccountType_ACCOUNT_TYPE_REWARD_MAKER_RECEIVED_FEES,
				Kind: &commandspb.Transfer_OneOff{
					OneOff: &commandspb.OneOffTransfer{},
				},
				To:        "84e2b15102a8d6c1c6b4bdf40af8a0dc21b040eaaa1c94cd10d17604b75fdc35",
		...
		},
		{
			transfer: commandspb.Transfer{
				FromAccountType: fury.AccountType_ACCOUNT_TYPE_GENERAL,
				ToAccountType:   fury.AccountType_ACCOUNT_TYPE_REWARD_MAKER_PAID_FEES,
				Kind: &commandspb.Transfer_OneOff{
					OneOff: &commandspb.OneOffTransfer{},
				},
				To:        "84e2b15102a8d6c1c6b4bdf40af8a0dc21b040eaaa1c94cd10d17604b75fdc35",
		...
		},
		{
			transfer: commandspb.Transfer{
				FromAccountType: fury.AccountType_ACCOUNT_TYPE_GENERAL,
				ToAccountType:   fury.AccountType_ACCOUNT_TYPE_REWARD_MARKET_PROPOSERS,
				Kind: &commandspb.Transfer_OneOff{
					OneOff: &commandspb.OneOffTransfer{},
				},
				To:        "84e2b15102a8d6c1c6b4bdf40af8a0dc21b040eaaa1c94cd10d17604b75fdc35",
		...
		},
		{
			transfer: commandspb.Transfer{
				FromAccountType: fury.AccountType_ACCOUNT_TYPE_GENERAL,
				ToAccountType:   fury.AccountType_ACCOUNT_TYPE_GLOBAL_REWARD,
				Kind: &commandspb.Transfer_OneOff{
					OneOff: &commandspb.OneOffTransfer{},
				},
				...
				Kind: &commandspb.Transfer_Recurring{
					Recurring: &commandspb.RecurringTransfer{
						...
						DispatchStrategy: &fury.DispatchStrategy{
							AssetForMetric: "",
							Metric:         fury.DispatchMetric_DISPATCH_METRIC_LP_FEES_RECEIVED,
						},
					},
				},
				To:        "84e2b15102a8d6c1c6b4bdf40af8a0dc21b040eaaa1c94cd10d17604b75fdc35",
	...
	invalidAccountTypesForOneOff := []fury.AccountType{
		fury.AccountType_ACCOUNT_TYPE_INSURANCE,
		fury.AccountType_ACCOUNT_TYPE_SETTLEMENT,
		fury.AccountType_ACCOUNT_TYPE_MARGIN,
		fury.AccountType_ACCOUNT_TYPE_FEES_INFRASTRUCTURE,
		fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY,
		fury.AccountType_ACCOUNT_TYPE_FEES_MAKER,
		fury.AccountType_ACCOUNT_TYPE_BOND,
		fury.AccountType_ACCOUNT_TYPE_EXTERNAL,
		fury.AccountType_ACCOUNT_TYPE_GLOBAL_INSURANCE,
		fury.AccountType_ACCOUNT_TYPE_PENDING_TRANSFERS,
		fury.AccountType_ACCOUNT_TYPE_REWARD_MAKER_RECEIVED_FEES,
		fury.AccountType_ACCOUNT_TYPE_REWARD_LP_RECEIVED_FEES,
		fury.AccountType_ACCOUNT_TYPE_REWARD_MARKET_PROPOSERS,
		fury.AccountType_ACCOUNT_TYPE_REWARD_MAKER_PAID_FEES,
	}
