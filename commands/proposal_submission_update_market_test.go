...
func TestCheckProposalSubmissionForUpdateMarket(t *testing.T) {
	...
	t.Run("Submitting a market with internal data source to terminate with `elysiumstation.builtin` in key name no signers succeeds", testUpdateMarketFutureMarketSubmissionWithInternalTimestampForTradingTerminationNoSignersSucceeds)
	...
	t.Run("Submitting a market with oracle to terminate with `elysiumstation.builtin` in key name no signers fails", testUpdateMarketFutureMarketSubmissionWithExternalSourceForTradingTerminationBuiltInKeyNoSignersFails)
	t.Run("Submitting a market with oracle to settle with `elysiumstation.builtin` in key name no signers fails", testUpdateMarketFutureMarketSubmissionWithExternalSourceForTradingSettlementBuiltInKeyNoSignersFails)
