...
import (
	...
	protoTypes "github.com/elysiumstation/fury/protos/fury"
...
func TestCheckProposalSubmissionForNewMarket(t *testing.T) {
	...
	t.Run("Submitting a future market with trading termination from external source with `elysiumstation.builtin` key and no public keys fails", testFutureMarketSubmissionWithExternalTradingTerminationBuiltInKeyNoPublicKeyFails)
	t.Run("Submitting a future market with trading settlement from external source with `elysiumstation.builtin` key and no public keys fails", testFutureMarketSubmissionWithExternalTradingSettlementBuiltInKeyNoPublicKeyFails)
...
// func testNewFutureMarketChangeSubmissionWithInvalidOracleSpecFuryPubkeySignerFails(t *testing.T) {
// 	err := checkProposalSubmission(&commandspb.ProposalSubmission{
// 		Terms: &protoTypes.ProposalTerms{
// 			Change: &protoTypes.ProposalTerms_NewMarket{
// 				NewMarket: &protoTypes.NewMarket{
...
func testNewFutureMarketChangeSubmissionWithoutEitherOracleSpecFails(t *testing.T, oracleSpecName string) {
	...
	if oracleSpecName == "data_source_spec_for_settlement_data" {
		future.DataSourceSpecForTradingTermination = &furypb.DataSourceDefinition{}
	} else {
		future.DataSourceSpecForSettlementData = &furypb.DataSourceDefinition{}
	}
				...
				NewMarket: &protoTypes.NewMarket{
					Changes: &protoTypes.NewMarketConfiguration{
						Instrument: &protoTypes.InstrumentConfiguration{
							Product: &protoTypes.InstrumentConfiguration_Future{
								Future: &protoTypes.FutureProduct{
									DataSourceSpecForSettlementData:     &furypb.DataSourceDefinition{},
									DataSourceSpecForTradingTermination: &furypb.DataSourceDefinition{},
								},
							},
						},
					},
				...
				NewMarket: &protoTypes.NewMarket{
					Changes: &protoTypes.NewMarketConfiguration{
						Instrument: &protoTypes.InstrumentConfiguration{
							Product: &protoTypes.InstrumentConfiguration_Future{
								Future: &protoTypes.FutureProduct{
									DataSourceSpecForSettlementData: furypb.NewDataSourceDefinition(furypb.DataSourceDefinitionTypeExt),
								},
							},
						},
					},
						...
						NewMarket: &protoTypes.NewMarket{
							Changes: &protoTypes.NewMarketConfiguration{
								Instrument: &protoTypes.InstrumentConfiguration{
									Product: &protoTypes.InstrumentConfiguration_Future{
										Future: &protoTypes.FutureProduct{
											DataSourceSpecForSettlementData: furypb.NewDataSourceDefinition(
...
func testNewFutureMarketChangeSubmissionWithBadPubKeysOrderAddressFail(t *testing.T) {
						...
						Instrument: &protoTypes.InstrumentConfiguration{
							Product: &protoTypes.InstrumentConfiguration_Future{
								Future: &protoTypes.FutureProduct{
									...
									DataSourceSpecForTradingTermination: furypb.NewDataSourceDefinition(
										furypb.DataSourceDefinitionTypeExt,
									).SetOracleConfig(
										&furypb.DataSourceSpecConfiguration{
											Signers: types.SignersIntoProto(pubKeys),
	...
	assert.Contains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.3"), commands.ErrIsNotValidFuryPubkey)
	...
	assert.Contains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.1"), commands.ErrIsNotValidFuryPubkey)
	assert.Contains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.0"), commands.ErrIsNotValidFuryPubkey)
}
...
func testNewFutureMarketChangeSubmissionWithGoodPubKeysOrderAddressSucceed(t *testing.T) {
	...
	assert.NotContains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.0"), commands.ErrIsNotValidFuryPubkey)
}
					...
					Changes: &protoTypes.NewMarketConfiguration{
						Instrument: &protoTypes.InstrumentConfiguration{
							Product: &protoTypes.InstrumentConfiguration_Future{
								Future: &protoTypes.FutureProduct{
									DataSourceSpecForTradingTermination: furypb.NewDataSourceDefinition(
										furypb.DataSourceDefinitionTypeInt,
									).SetOracleConfig(
										&furypb.DataSourceSpecConfiguration{
											Signers: []*datapb.Signer{},
											Filters: []*datapb.Filter{
									...
									DataSourceSpecForTradingTermination: furypb.NewDataSourceDefinition(
										...
										&furypb.DataSourceSpecConfiguration{
											...
											Filters: []*datapb.Filter{
												{
													Key: &datapb.PropertyKey{
														Name: "elysiumstation.builtin.timestamp",
									...
									DataSourceSpecForSettlementData: furypb.NewDataSourceDefinition(
										...
										&furypb.DataSourceSpecConfiguration{
											...
											Filters: []*datapb.Filter{
												{
													Key: &datapb.PropertyKey{
														Name: "elysiumstation.builtin.prices.ETH.value",
														Type: datapb.PropertyKey_TYPE_INTEGER,
													},
													Conditions: []*datapb.Condition{
														{
