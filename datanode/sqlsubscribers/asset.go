...
func (a *Asset) consume(ctx context.Context, ae AssetEvent) error {
	err := a.addAsset(ctx, ae.Asset(), ae.TxHash(), a.furyTime)
	if err != nil {
...
func (a *Asset) addAsset(ctx context.Context, va fury.Asset, txHash string, furyTime time.Time) error {
	...
	case *fury.AssetDetails_BuiltinAsset:
		source = src.BuiltinAsset.MaxFaucetAmountMint
	case *fury.AssetDetails_Erc20:
