...
// CandleStore ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/candle_store_mock.go -package mocks github.com/elysiumstation/fury/datanode/candlesv2 CandleStore
