...
func TestCursors_Where(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			wantWhere: "fury_time = $1 AND seq_num >= $2",
...
func TestCursors_OrderBy(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			wantOrder: "fury_time ASC, seq_num ASC",
		},
	}
