...
func addTestBlockForTime(t *testing.T, ctx context.Context, bs *sqlstore.Blocks, furyTime time.Time) entities.Block {
	t.Helper()
	return addTestBlockForHeightAndTime(t, ctx, bs, 2, furyTime)
}

func addTestBlockForHeightAndTime(t *testing.T, ctx context.Context, bs *sqlstore.Blocks, height int64, furyTime time.Time) entities.Block {
	t.Helper()
	// Make a block
