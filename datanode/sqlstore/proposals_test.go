...
func assertProposalsMatch(t *testing.T, expected, actual []entities.Proposal) {
	...
	ignoreProtoState := cmpopts.IgnoreUnexported(fury.ProposalTerms{}, fury.ProposalRationale{}, fury.NewMarket{}, fury.NewAsset{})
...
func TestProposals(t *testing.T) {
	...
	rationale1 := entities.ProposalRationale{ProposalRationale: &fury.ProposalRationale{Title: "myurl1.com", Description: "desc"}}
	rationale2 := entities.ProposalRationale{ProposalRationale: &fury.ProposalRationale{Title: "myurl2.com", Description: "desc"}}
	terms1 := entities.ProposalTerms{ProposalTerms: &fury.ProposalTerms{Change: &fury.ProposalTerms_NewMarket{NewMarket: &fury.NewMarket{}}}}
	terms2 := entities.ProposalTerms{ProposalTerms: &fury.ProposalTerms{Change: &fury.ProposalTerms_NewAsset{NewAsset: &fury.NewAsset{}}}}
...
func createPaginationTestProposals(t *testing.T, ctx context.Context, pps *sqlstore.Proposals) ([]entities.Proposal, []entities.Party) {
	...
	for i < 10 {
		...
		rationale1 := entities.ProposalRationale{ProposalRationale: &fury.ProposalRationale{Title: fmt.Sprintf("https://rationale1-%02d.com", i), Description: "desc"}}
		rationale2 := entities.ProposalRationale{ProposalRationale: &fury.ProposalRationale{Title: fmt.Sprintf("https://rationale1-%02d.com", i+10), Description: "desc"}}
		terms1 := entities.ProposalTerms{ProposalTerms: &fury.ProposalTerms{Change: &fury.ProposalTerms_NewMarket{NewMarket: &fury.NewMarket{}}}}
		terms2 := entities.ProposalTerms{ProposalTerms: &fury.ProposalTerms{Change: &fury.ProposalTerms_NewAsset{NewAsset: &fury.NewAsset{}}}}
