...
func addTestNode(t *testing.T, ctx context.Context, ps *sqlstore.Node, block entities.Block, id string) entities.Node {
	...
	node := entities.Node{
		...
		PubKey:          entities.FuryPublicKey(helpers.GenerateID()),
...
func addNodeAnnounced(t *testing.T, ctx context.Context, ps *sqlstore.Node, nodeID entities.NodeID, added bool, epochSeq uint64, furytime time.Time) {
	t.Helper()
	aux := entities.ValidatorUpdateAux{
		Added:    added,
		EpochSeq: epochSeq,
	}
	err := ps.AddNodeAnnouncedEvent(ctx, nodeID.String(), furytime, &aux)
	require.NoError(t, err)
}
...
func TestUpdateNodePubKey(t *testing.T) {
	...
	kr := entities.KeyRotation{
		...
		NewPubKey: entities.FuryPublicKey(helpers.GenerateID()),
		FuryTime:  block.FuryTime,
	}
...
func addPaginationTestNodes(t *testing.T, ctx context.Context, ns *sqlstore.Node) (nodes []entities.Node) {
	...
	addNodeAnnounced(t, ctx, ns, nodes[0].ID, true, 1, nodes[0].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[1].ID, true, 1, nodes[1].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[2].ID, true, 1, nodes[2].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[3].ID, true, 1, nodes[3].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[4].ID, true, 1, nodes[4].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[5].ID, true, 1, nodes[5].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[6].ID, true, 1, nodes[6].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[7].ID, true, 1, nodes[7].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[8].ID, true, 1, nodes[8].FuryTime)
	addNodeAnnounced(t, ctx, ns, nodes[9].ID, true, 1, nodes[9].FuryTime)
