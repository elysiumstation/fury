...
func HasFurySchema(ctx context.Context, conn Connection) (bool, error) {
...
func RecreateFuryDatabase(ctx context.Context, log *logging.Logger, connConfig ConnectionConfig) error {
...
func GetDatanodeBlockSpan(ctx context.Context, connPool *pgxpool.Pool) (DatanodeBlockSpan, error) {
	hasFurySchema, err := HasFurySchema(ctx, connPool)
	if err != nil {
