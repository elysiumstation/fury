...
func addSnapshot(t *testing.T, ctx context.Context, ss *sqlstore.CoreSnapshotData, bs *sqlstore.Blocks, entity entities.CoreSnapshotData) {
	...
	entity.FuryTime = block.FuryTime
...
func TestGetSnapshots(t *testing.T) {
	...
	addSnapshot(t, ctx, ss, bs, entities.CoreSnapshotData{BlockHeight: 100, FuryCoreVersion: "v0.65.0"})
	...
	require.Equal(t, "v0.65.0", entities[0].FuryCoreVersion)
}
