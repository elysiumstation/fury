...
func populateTestParties(ctx context.Context, t *testing.T, bs *sqlstore.Blocks, ps *sqlstore.Parties, blockTimes map[string]time.Time) {
	...
	for _, party := range parties {
		...
		party.FuryTime = &block.FuryTime
		blockTimes[party.ID.String()] = block.FuryTime
		err := ps.Add(ctx, party)
		require.NoError(t, err)
	}
}
...
func testPartyPaginationReturnAllParties(t *testing.T) {
	...
	startFuryTime := blockTimes["02a16077"]
	startParty := entities.Party{
		ID:       "02a16077",
		FuryTime: &startFuryTime,
	}.String()
	endFuryTime := blockTimes["fb1528a5"]
	endParty := entities.Party{
		ID:       "fb1528a5",
		FuryTime: &endFuryTime,
	}.String()
...
func testPartyPaginationReturnsFirstPage(t *testing.T) {
	...
	endFuryTime := blockTimes["65be62cd"]
	endParty := entities.Party{
		ID:       "65be62cd",
		FuryTime: &endFuryTime,
	}.String()
...
func testPartyPaginationReturnsLastPage(t *testing.T) {
	...
	startFuryTime := blockTimes["c8744329"]
	startParty := entities.Party{
		ID:       "c8744329",
		FuryTime: &startFuryTime,
	}.String()
...
func testPartyPaginationReturnsPageTraversingForward(t *testing.T) {
	...
	populateTestParties(ctx, t, bs, pt, blockTimes)
	first := int32(3)
	afterFuryTime := blockTimes["65be62cd"]
	afterParty := entities.Party{
		ID:       "65be62cd",
		FuryTime: &afterFuryTime,
	}.String()
	...
	startFuryTime := blockTimes["7a797e0e"]
	startParty := entities.Party{
		ID:       "7a797e0e",
		FuryTime: &startFuryTime,
	}.String()
	endFuryTime := blockTimes["b7c84b8e"]
	endParty := entities.Party{
		ID:       "b7c84b8e",
		FuryTime: &endFuryTime,
	}.String()
...
func testPartyPaginationReturnsPageTraversingBackward(t *testing.T) {
	...
	populateTestParties(ctx, t, bs, pt, blockTimes)
	last := int32(3)
	beforeFuryTime := blockTimes["c8744329"]
	beforeParty := entities.Party{
		ID:       "c8744329",
		FuryTime: &beforeFuryTime,
	}.String()
	...
	startFuryTime := blockTimes["7bb2356e"]
	startParty := entities.Party{
		ID:       "7bb2356e",
		FuryTime: &startFuryTime,
	}.String()
	endFuryTime := blockTimes["c612300d"]
	endParty := entities.Party{
		ID:       "c612300d",
		FuryTime: &endFuryTime,
	}.String()
...
func testPartyPaginationReturnsTheSpecifiedPartyNewestFirst(t *testing.T) {
	...
	startFuryTime := blockTimes["c612300d"]
	startParty := entities.Party{
		ID:       "c612300d",
		FuryTime: &startFuryTime,
	}.String()
...
func testPartyPaginationReturnAllPartiesNewestFirst(t *testing.T) {
	...
	startFuryTime := blockTimes["fb1528a5"]
	startParty := entities.Party{
		ID:       "fb1528a5",
		FuryTime: &startFuryTime,
	}.String()
	endFuryTime := blockTimes["02a16077"]
	endParty := entities.Party{
		ID:       "02a16077",
		FuryTime: &endFuryTime,
	}.String()
...
func testPartyPaginationReturnsFirstPageNewestFirst(t *testing.T) {
	...
	endFuryTime := blockTimes["c8744329"]
	endParty := entities.Party{
		ID:       "c8744329",
		FuryTime: &endFuryTime,
	}.String()
...
func testPartyPaginationReturnsLastPageNewestFirst(t *testing.T) {
	...
	startFuryTime := blockTimes["65be62cd"]
	startParty := entities.Party{
		ID:       "65be62cd",
		FuryTime: &startFuryTime,
	}.String()
...
func testPartyPaginationReturnsPageTraversingForwardNewestFirst(t *testing.T) {
	...
	populateTestParties(ctx, t, bs, pt, blockTimes)
	first := int32(3)
	afterFuryTime := blockTimes["c8744329"]
	afterParty := entities.Party{
		ID:       "c8744329",
		FuryTime: &afterFuryTime,
	}.String()
	...
	endFuryTime := blockTimes["7bb2356e"]
	endParty := entities.Party{
		ID:       "7bb2356e",
		FuryTime: &endFuryTime,
	}.String()
...
func testPartyPaginationReturnsPageTraversingBackwardNewestFirst(t *testing.T) {
	...
	populateTestParties(ctx, t, bs, pt, blockTimes)
	last := int32(3)
	beforeFuryTime := blockTimes["65be62cd"]
	beforeParty := entities.Party{
		ID:       "65be62cd",
		FuryTime: &beforeFuryTime,
	}.String()
	...
	startFuryTime := blockTimes["b7c84b8e"]
	startParty := entities.Party{
		ID:       "b7c84b8e",
		FuryTime: &startFuryTime,
	}.String()
	endFuryTime := blockTimes["7a797e0e"]
	endParty := entities.Party{
		ID:       "7a797e0e",
		FuryTime: &endFuryTime,
	}.String()
