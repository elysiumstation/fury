...
func setupPaginationTestVotes(t *testing.T, ctx context.Context) (*sqlstore.Votes, entities.Party, []entities.Vote) {
	...
	for i := 0; i < 10; i++ {
		...
		prop := addTestProposal(t,
			...
			entities.ProposalRationale{ProposalRationale: &fury.ProposalRationale{Title: fmt.Sprintf("myurl%02d.com", i+1), Description: "desc"}},
			entities.ProposalTerms{ProposalTerms: &fury.ProposalTerms{Change: &fury.ProposalTerms_NewMarket{}}},
		)
