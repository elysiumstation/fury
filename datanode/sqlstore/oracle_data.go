...
const (
	sqlOracleDataColumns = `signers, data, matched_spec_ids, broadcast_at, tx_hash, fury_time, seq_num`
)
...
func (od *OracleData) Add(ctx context.Context, oracleData *entities.OracleData) error {
	...
	if _, err := od.Connection.Exec(ctx, query, oracleData.ExternalData.Data.Signers, oracleData.ExternalData.Data.Data, oracleData.ExternalData.Data.MatchedSpecIds,
		oracleData.ExternalData.Data.BroadcastAt, oracleData.ExternalData.Data.TxHash, oracleData.ExternalData.Data.FuryTime, oracleData.ExternalData.Data.SeqNum); err != nil {
