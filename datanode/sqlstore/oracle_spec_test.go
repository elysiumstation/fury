...
func testInsertIntoNewBlock(t *testing.T) {
	...
	proto := specProtos[0]
	data, err := entities.OracleSpecFromProto(proto, generateTxHash(), block.FuryTime)
...
func testGetSpecByID(t *testing.T) {
	...
	want, err := entities.DataSourceSpecFromProto(specProtos[0].ExternalDataSourceSpec.Spec, got.ExternalDataSourceSpec.Spec.TxHash, block.FuryTime)
...
func getTestSpecs() []*furypb.OracleSpec {
