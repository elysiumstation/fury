...
const (
	sqlRiskFactorColumns = `market_id, short, long, tx_hash, fury_time`
)
...
values ($1, $2, $3, $4, $5)
on conflict (market_id, fury_time) do update
set
	short=EXCLUDED.short,
	long=EXCLUDED.long,
	tx_hash=EXCLUDED.tx_hash`, sqlRiskFactorColumns)

	if _, err := rf.Connection.Exec(ctx, query, factor.MarketID, factor.Short, factor.Long, factor.TxHash, factor.FuryTime); err != nil {
