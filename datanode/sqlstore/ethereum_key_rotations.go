...
func (store *EthereumKeyRotations) Add(ctx context.Context, kr entities.EthereumKeyRotation) error {
	...
	_, err := store.Connection.Exec(ctx, `
		INSERT INTO ethereum_key_rotations(node_id, old_address, new_address, block_height, tx_hash, fury_time, seq_num)
		VALUES ($1, $2, $3, $4, $5, $6, $7)
	`, kr.NodeID, kr.OldAddress, kr.NewAddress, kr.BlockHeight, kr.TxHash, kr.FuryTime, kr.SeqNum)
