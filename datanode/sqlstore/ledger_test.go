...
func ledgerEntryEqual(t *testing.T, expected, actual entities.LedgerEntry) {
	...
	assert.Equal(t, expected.FuryTime, actual.FuryTime)
...
func addTestLedgerEntry(t *testing.T, ledger *sqlstore.Ledger,
	...
	ledgerEntry := entities.LedgerEntry{
		...
		TransferTime:       block.FuryTime.Add(-time.Second),
		Type:               transferType,
...
func TestLedger(t *testing.T) {
	...
	/*
		...
		--- accounts ---
		accounts[0] => asset1, parties[0], markets[0], fury.AccountType_ACCOUNT_TYPE_GENERAL
		accounts[1] => asset1, parties[0], markets[1], fury.AccountType_ACCOUNT_TYPE_GENERAL
		accounts[2] => asset1, parties[1], markets[1], fury.AccountType_ACCOUNT_TYPE_GENERAL
		accounts[3] => asset1, parties[1], markets[2], fury.AccountType_ACCOUNT_TYPE_GENERAL

		accounts[4] => asset2, parties[2], markets[2], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[5] => asset2, parties[2], markets[3], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[6] => asset2, parties[3], markets[3], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[7] => asset2, parties[3], markets[4], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[8] => asset2, parties[4], markets[4], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[9] => asset2, parties[4], markets[5], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[10] => asset2, parties[5], markets[5], fury.AccountType_ACCOUNT_TYPE_GENERAL
		accounts[11] => asset2, parties[5], markets[6], fury.AccountType_ACCOUNT_TYPE_GENERAL

		accounts[12] => asset3, parties[6], markets[6], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[13] => asset3, parties[6], markets[7], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[14] => asset3, parties[7], markets[7], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[15] => asset3, parties[7], markets[8], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[16] => asset3, parties[8], markets[8], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[17] => asset3, parties[8], markets[9], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[18] => asset3, parties[9], markets[9], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[19] => asset3, parties[9], markets[10], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[20] => asset3, parties[10], markets[10], fury.AccountType_ACCOUNT_TYPE_FEES_INSURANCE
		accounts[21] => asset3, parties[10], markets[11], fury.AccountType_ACCOUNT_TYPE_FEES_INSURANCE
	*/
	for i := 0; i < 17; i++ {
	...
	for i := 0; i < 11; i++ {
		...
		if i < 2 {
			// accounts 0, 1, 2, 3
			fromAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset1, blocks[i], markets[i].ID, fury.AccountType_ACCOUNT_TYPE_GENERAL)
			toAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset1, blocks[i], markets[mt].ID, fury.AccountType_ACCOUNT_TYPE_GENERAL)
		...
		if i >= 2 && i < 5 {
			fromAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset2, blocks[i], markets[i].ID, fury.AccountType_ACCOUNT_TYPE_INSURANCE)
			toAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset2, blocks[i], markets[mt].ID, fury.AccountType_ACCOUNT_TYPE_INSURANCE)
			accounts = append(accounts, fromAccount)
			accounts = append(accounts, toAccount)
			continue
		}
		...
		// accounts 10, 11
		if i >= 5 && i < 6 {
			fromAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset2, blocks[i], markets[i].ID, fury.AccountType_ACCOUNT_TYPE_GENERAL)
			toAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset2, blocks[i], markets[mt].ID, fury.AccountType_ACCOUNT_TYPE_GENERAL)
			accounts = append(accounts, fromAccount)
			accounts = append(accounts, toAccount)
			continue
		}
		...
		if i >= 6 && i < 10 {
			fromAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset3, blocks[i], markets[i].ID, fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY)
			toAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset3, blocks[i], markets[mt].ID, fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY)
			accounts = append(accounts, fromAccount)
			accounts = append(accounts, toAccount)
			continue
		}
		...
		// accounts 20, 21
		fromAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset3, blocks[i], markets[i].ID, fury.AccountType_ACCOUNT_TYPE_INSURANCE)
		toAccount := helpers.AddTestAccountWithMarketAndType(t, ctx, accountStore, parties[i], asset3, blocks[i], markets[mt].ID, fury.AccountType_ACCOUNT_TYPE_INSURANCE)
		accounts = append(accounts, fromAccount)
		accounts = append(accounts, toAccount)
	}
	...
	/*
		--- Transfers ---
		Asset1:
		accounts[0]->accounts[1] => asset1, parties[0], markets[0-1], fury.AccountType_ACCOUNT_TYPE_GENERAL
		accounts[2]->accounts[3] => asset1, parties[1], markets[1-2], fury.AccountType_ACCOUNT_TYPE_GENERAL

		Asset2:
		accounts[4]->accounts[5] => asset2, parties[2], markets[2-3], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[6]->accounts[7] => asset2, parties[3], markets[3-4], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[6]->accounts[7] => asset2, parties[3], markets[3-4], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[6]->accounts[7] => asset2, parties[3], markets[3-4], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[8]->accounts[9] => asset2, parties[4], markets[4-5], fury.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[10]->accounts[11] => asset2, parties[5], markets[5-6], fury.AccountType_ACCOUNT_TYPE_GENERAL

		accounts[5]->accounts[10] => asset2, parties[2-5], markets[3-5], fury.AccountType_ACCOUNT_TYPE_INSURANCE -> fury.AccountType_ACCOUNT_TYPE_GENERAL
		accounts[5]->accounts[11] => asset2, parties[2-5], markets[3-6], fury.AccountType_ACCOUNT_TYPE_INSURANCE -> fury.AccountType_ACCOUNT_TYPE_GENERAL
		accounts[4]->accounts[11] => asset2, parties[2-5], markets[2-6], fury.AccountType_ACCOUNT_TYPE_INSURANCE -> fury.AccountType_ACCOUNT_TYPE_GENERAL

		Asset3:
		accounts[14]->accounts[16] => asset3, parties[7-8], markets[7-8], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY

		accounts[17]->accounts[15] => asset3, parties[8-7], markets[9-8], fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY

		accounts[21]->accounts[15] => asset3, parties[10-7], markets[9-8], fury.AccountType_ACCOUNT_TYPE_INSURANCE -> fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
	...
	t.Run("query ledger entries with filters", func(t *testing.T) {
		t.Run("by fromAccount filter", func(t *testing.T) {
			...
			for _, e := range *entries {
				assert.Equal(t, *e.FromAccountType, fury.AccountType_ACCOUNT_TYPE_INSURANCE)
				assert.Equal(t, *e.ToAccountType, fury.AccountType_ACCOUNT_TYPE_INSURANCE)
			...
			filter.FromAccountFilter.AccountTypes = []fury.AccountType{fury.AccountType_ACCOUNT_TYPE_GENERAL}
		...
		t.Run("by toAccount filter", func(t *testing.T) {
			...
			filter.ToAccountFilter.AccountTypes = []fury.AccountType{fury.AccountType_ACCOUNT_TYPE_GENERAL, fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY}
		...
		t.Run("by fromAccount+toAccount filters", func(t *testing.T) {
			t.Run("open", func(t *testing.T) {
				...
				for _, e := range *entries {
					assert.Equal(t, *e.FromAccountType, fury.AccountType_ACCOUNT_TYPE_GENERAL)
					assert.Equal(t, *e.ToAccountType, fury.AccountType_ACCOUNT_TYPE_GENERAL)
					assert.Equal(t, *e.TransferType, entities.LedgerMovementTypeBondSlashing)
			...
			t.Run("closed", func(t *testing.T) {
				...
				filter.ToAccountFilter.AccountTypes = []fury.AccountType{fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY}
				entries, _, err = ledgerStore.Query(ctx,
					filter,
					entities.DateRange{Start: &tStart, End: &tEnd},
					entities.CursorPagination{},
				...
				for _, e := range *entries {
					...
					assert.Equal(t, *e.FromAccountType, fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY)
					assert.Equal(t, *e.ToAccountType, fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY)
					assert.Equal(t, *e.TransferType, entities.LedgerMovementTypeDeposit)
		...
		t.Run("by account filters+transferType", func(t *testing.T) {
			...
			filter.ToAccountFilter = entities.AccountFilter{
				AssetID:      asset3.ID,
				AccountTypes: []fury.AccountType{fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY},
			}
		...
		t.Run("test open/closing with different account and transfer types", func(t *testing.T) {
			...
			filter = &entities.LedgerEntryFilter{
				...
				ToAccountFilter: entities.AccountFilter{
					AccountTypes: []types.AccountType{fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY},
				},
				TransferTypes: []entities.LedgerMovementType{
					entities.LedgerMovementTypeRewardPayout,
				},
			}
			filter.FromAccountFilter.AccountTypes = append(filter.FromAccountFilter.AccountTypes, fury.AccountType_ACCOUNT_TYPE_INSURANCE)
			entries, _, err = ledgerStore.Query(ctx,
				filter,
				entities.DateRange{Start: &tStart, End: &tEnd},
				entities.CursorPagination{},
		...
		t.Run("test with same account and transfer types given multiple times", func(t *testing.T) {
			filter := &entities.LedgerEntryFilter{
				FromAccountFilter: entities.AccountFilter{
					PartyIDs:     []entities.PartyID{parties[2].ID},
					AccountTypes: []types.AccountType{fury.AccountType_ACCOUNT_TYPE_INSURANCE, fury.AccountType_ACCOUNT_TYPE_INSURANCE, fury.AccountType_ACCOUNT_TYPE_INSURANCE},
				},
				ToAccountFilter: entities.AccountFilter{
					AccountTypes: []types.AccountType{fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY, fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY},
				},
				TransferTypes: []entities.LedgerMovementType{
			...
			filter = &entities.LedgerEntryFilter{
				FromAccountFilter: entities.AccountFilter{
					...
					AccountTypes: []types.AccountType{
						fury.AccountType_ACCOUNT_TYPE_INSURANCE, fury.AccountType_ACCOUNT_TYPE_INSURANCE, fury.AccountType_ACCOUNT_TYPE_INSURANCE,
						fury.AccountType_ACCOUNT_TYPE_GENERAL, fury.AccountType_ACCOUNT_TYPE_GENERAL,
					},
				},
				ToAccountFilter: entities.AccountFilter{
					AccountTypes: []types.AccountType{fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY, fury.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY},
