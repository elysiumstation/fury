...
func (r Reward) ToProto() *fury.Reward {
	protoReward := fury.Reward{
...
func RewardFromProto(pr eventspb.RewardPayoutEvent, txHash TxHash, furyTime time.Time, seqNum uint64) (Reward, error) {
