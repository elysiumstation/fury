...
func (p Position) ToProto() *fury.Position {
	...
	return &fury.Position{
		...
		PositionStatus:          fury.PositionStatus(p.DistressedStatus),
	}
}
...
func (p Position) Key() PositionKey {
	return PositionKey{p.MarketID, p.PartyID, p.FuryTime}
}
...
func (p Position) ToRow() []interface{} {
	return []interface{}{
		...
		p.AverageEntryPrice, p.AverageEntryMarketPrice, p.Loss, p.Adjustment, p.TxHash, p.FuryTime, p.PendingOpenVolume,
