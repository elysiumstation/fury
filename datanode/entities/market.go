...
func NewMarketFromProto(market *fury.Market, txHash TxHash, furyTime time.Time) (*Market, error) {
	var err error
...
func (m Market) ToProto() *fury.Market {
	...
	return &fury.Market{
		...
		TradingMode:                   fury.Market_TradingMode(m.TradingMode),
		State:                         fury.Market_State(m.State),
...
func marketTimestampsFromProto(ts *fury.MarketTimestamps) (MarketTimestamps, error) {
	if ts == nil {
...
func (tsp TargetStakeParameters) ToProto() *fury.TargetStakeParameters {
	return &fury.TargetStakeParameters{
...
func (lmp LiquidityMonitoringParameters) ToProto() *fury.LiquidityMonitoringParameters {
	...
	return &fury.LiquidityMonitoringParameters{
...
func liquidityMonitoringParametersFromProto(lmp *fury.LiquidityMonitoringParameters) (LiquidityMonitoringParameters, error) {
	if lmp == nil {
...
func priceMonitoringParametersFromProto(pmp *fury.PriceMonitoringParameters) PriceMonitoringParameters {
...
func (s PriceMonitoringSettings) ToProto() *fury.PriceMonitoringSettings {
	...
	triggers := make([]*fury.PriceMonitoringTrigger, 0, len(s.Parameters.Triggers))
	...
	return &fury.PriceMonitoringSettings{
...
func priceMonitoringSettingsFromProto(pms *fury.PriceMonitoringSettings) (PriceMonitoringSettings, error) {
	if pms == nil {
...
func feesFromProto(fees *fury.Fees) (Fees, error) {
	if fees == nil {
