...
// FuryTime and Quantity will always be set. The others will be nil unless when
...
func (ledgerEntries *AggregatedLedgerEntry) ToProto() *v2.AggregatedLedgerEntry {
	...
	lep.Timestamp = ledgerEntries.FuryTime.UnixNano()

	if ledgerEntries.TransferType != nil {
		lep.TransferType = fury.TransferType(*ledgerEntries.TransferType)
	}
...
func (ledgerEntries AggregatedLedgerEntry) Cursor() *Cursor {
	return NewCursor(AggregatedLedgerEntriesCursor{
		FuryTime: ledgerEntries.FuryTime,
	}.String())
}
