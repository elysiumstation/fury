...
func (o Order) ToProto() *fury.Order {
	var peggedOrder *fury.PeggedOrder
	if o.PeggedReference != types.PeggedReferenceUnspecified {
		peggedOrder = &fury.PeggedOrder{
	...
	var icebergOrder *fury.IcebergOrder
	if o.InitialPeakSize != nil {
		icebergOrder = &fury.IcebergOrder{
...
func OrderFromProto(po *fury.Order, seqNum uint64, txHash TxHash) (Order, error) {
...
func (o Order) Key() OrderKey {
	return OrderKey{o.ID, o.Version, o.FuryTime}
}
...
func (o Order) ToRow() []interface{} {
	return []interface{}{
		...
		o.TxHash, o.FuryTime, o.SeqNum, o.PostOnly, o.ReduceOnly, o.ReservedRemaining,
