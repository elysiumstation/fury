...
func DepositFromProto(deposit *fury.Deposit, txHash TxHash, furyTime time.Time) (*Deposit, error) {
	var err error
...
func (d Deposit) ToProto() *fury.Deposit {
	return &fury.Deposit{
		Id:                d.ID.String(),
		Status:            fury.Deposit_Status(d.Status),
