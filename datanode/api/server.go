...
import (
	...
	"github.com/elysiumstation/fury/datanode/ratelimit"

	"github.com/elysiumstation/fury/core/events"
	"github.com/elysiumstation/fury/datanode/candlesv2"
	"github.com/elysiumstation/fury/datanode/contextutil"
	...
	protoapi "github.com/elysiumstation/fury/protos/data-node/api/v2"
...
// EventService ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/event_service_mock.go -package mocks github.com/elysiumstation/fury/datanode/api EventService
...
// BlockService ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/block_service_mock.go -package mocks github.com/elysiumstation/fury/datanode/api BlockService
...
//
// it would be nice to use go:generate go run github.com/golang/mock/mockgen -destination mocks/networkhistory_service_mock.go -package mocks github.com/elysiumstation/fury/datanode/api NetworkHistoryService
...
type GRPCServer struct {
	...
	log                   *logging.Logger
	srv                   *grpc.Server
	furyCoreServiceClient CoreServiceClient
...
func (g *GRPCServer) Start(ctx context.Context, lis net.Listener) error {
	...
	coreProxySvc := &coreProxyService{
		conf:              g.Config,
		coreServiceClient: g.furyCoreServiceClient,
		eventObserver:     g.eventObserver,
	}
	g.coreProxySvc = coreProxySvc
	furyprotoapi.RegisterCoreServiceServer(g.srv, coreProxySvc)
...
func (g *GRPCServer) startWebUI(ctx context.Context) {
	...
	uiHandler, err := standalone.HandlerViaReflection(ctx, cc, "fury data node")
	if err != nil {
