...
// Source: github.com/elysiumstation/fury/datanode/api (interfaces: CoreServiceClient)
...
func (m *MockCoreServiceClient) GetFuryTime(arg0 context.Context, arg1 *v1.GetFuryTimeRequest, arg2 ...grpc.CallOption) (*v1.GetFuryTimeResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (mr *MockCoreServiceClientMockRecorder) GetFuryTime(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFuryTime", reflect.TypeOf((*MockCoreServiceClient)(nil).GetFuryTime), varargs...)
}
