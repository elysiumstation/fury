...
// CoreServiceClient ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/core_service_client_mock.go -package mocks github.com/elysiumstation/fury/datanode/api CoreServiceClient
...
func (t *coreProxyService) GetFuryTime(ctx context.Context, req *protoapi.GetFuryTimeRequest) (*protoapi.GetFuryTimeResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, defaultRequestTimeout)
	defer cancel()

	return t.coreServiceClient.GetFuryTime(ctx, req)
}
