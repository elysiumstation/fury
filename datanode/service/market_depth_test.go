...
import (
	...
	"github.com/elysiumstation/fury/datanode/service/mocks"
...
func TestCancelOrder(t *testing.T) {
	...
	mds.AddOrder(&cancelorder, furyTime, 2)
...
func TestAmendOrderPrice(t *testing.T) {
	...
	mds.AddOrder(&amendorder, furyTime, 3)
...
func TestAmendOrderVolumeUp(t *testing.T) {
	...
	mds.AddOrder(&amendorder, furyTime, 2)
...
func TestPartialFill(t *testing.T) {
	...
	pforder := *order
	pforder.Remaining = 5
	mds.AddOrder(&pforder, furyTime, 2)
...
func TestFullyFill(t *testing.T) {
	...
	mds.AddOrder(&fforder, furyTime, 2)
...
func TestMarketOrder(t *testing.T) {
	...
	mds.AddOrder(marketorder, furyTime, 1)
...
func TestFOKOrder(t *testing.T) {
	...
	mds.AddOrder(fokorder, furyTime, 1)
...
func TestIOCOrder(t *testing.T) {
	...
	mds.AddOrder(iocorder, furyTime, 1)
...
func TestParkedOrder2(t *testing.T) {
	...
	mds.AddOrder(order9, furyTime, 9)
	...
	mds.AddOrder(order10, furyTime, 10)
		...
		store.EXPECT().GetLiveOrders(gomock.Any()).Return([]entities.Order{
			{
				...
				UpdatedAt:       time.Time{},
				ExpiresAt:       time.Time{},
				FuryTime:        time.Date(2022, 3, 8, 14, 14, 45, 762739000, time.UTC),
				SeqNum:          32,
			},
			{
				...
				UpdatedAt:       time.Time{},
				ExpiresAt:       time.Time{},
				FuryTime:        time.Date(2022, 3, 8, 14, 11, 39, 901022000, time.UTC),
				SeqNum:          32,
			},
			{
			...
			},
			{
				...
				UpdatedAt:       time.Time{},
				ExpiresAt:       time.Time{},
				FuryTime:        time.Date(2022, 3, 8, 14, 14, 58, 985875000, time.UTC),
				SeqNum:          61,
			},
			{
