...
type updateMarketConfigurationResolver FuryResolverRoot

func (r *updateMarketConfigurationResolver) Instrument(ctx context.Context,
	obj *fury.UpdateMarketConfiguration,
	...
	var product *fury.UpdateFutureProduct

	switch p := protoInstrument.Product.(type) {
	case *fury.UpdateInstrumentConfiguration_Future:
		product = &fury.UpdateFutureProduct{
...
func (r *updateMarketConfigurationResolver) RiskParameters(ctx context.Context,
	...
	case *fury.UpdateMarketConfiguration_Simple:
		params = rp
	case *fury.UpdateMarketConfiguration_LogNormal:
		params = rp
	default:
