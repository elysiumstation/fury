...
type proposalResolver FuryResolverRoot

func (r *proposalResolver) RejectionReason(_ context.Context, data *types.GovernanceData) (*fury.ProposalError, error) {
...
func (r *proposalResolver) State(_ context.Context, data *types.GovernanceData) (fury.Proposal_State, error) {
	if data == nil || data.Proposal == nil {
		return fury.Proposal_STATE_UNSPECIFIED, ErrInvalidProposal
	}
