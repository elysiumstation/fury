...
type rewardSummaryResolver FuryResolverRoot

func (r *rewardSummaryResolver) Asset(ctx context.Context, obj *fury.RewardSummary) (*fury.Asset, error) {
	return r.r.getAssetByID(ctx, obj.AssetId)
}

func (r *rewardSummaryResolver) RewardsConnection(ctx context.Context, summary *fury.RewardSummary, assetID *string, pagination *v2.Pagination) (*v2.RewardsConnection, error) {
