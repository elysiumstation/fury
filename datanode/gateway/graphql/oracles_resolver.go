...
type oracleSpecResolver FuryResolverRoot

func (o *oracleSpecResolver) DataSourceSpec(_ context.Context, obj *furypb.OracleSpec) (extDss *ExternalDataSourceSpec, _ error) {
...
func (o *oracleSpecResolver) DataConnection(ctx context.Context, obj *furypb.OracleSpec, pagination *v2.Pagination) (*v2.OracleDataConnection, error) {
	var specID *string
...
type oracleDataResolver FuryResolverRoot

func (o *oracleDataResolver) ExternalData(_ context.Context, obj *furypb.OracleData) (ed *ExternalData, _ error) {
	ed = &ExternalData{
		Data: &Data{},
	}
...
func resolveDataSourceDefinition(d *furypb.DataSourceDefinition) (ds *DataSourceDefinition) {
...
func resolveDataSourceSpec(d *furypb.DataSourceSpec) (ds *DataSourceSpec) {
	ds = &DataSourceSpec{
	...
	switch d.Status {
	case furypb.DataSourceSpec_STATUS_ACTIVE:
		ds.Status = DataSourceSpecStatusStatusActive
	case furypb.DataSourceSpec_STATUS_DEACTIVATED:
