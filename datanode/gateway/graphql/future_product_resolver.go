...
type myFutureProductResolver FuryResolverRoot
...
func (r *myFutureProductResolver) DataSourceSpecForSettlementData(_ context.Context, obj *furypb.FutureProduct) (*DataSourceDefinition, error) {
...
func (r *myFutureProductResolver) DataSourceSpecForTradingTermination(_ context.Context, obj *furypb.FutureProduct) (*DataSourceDefinition, error) {
