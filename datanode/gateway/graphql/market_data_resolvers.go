...
type myMarketDataResolver FuryResolverRoot

func (r *myMarketDataResolver) AuctionStart(_ context.Context, m *types.MarketData) (*string, error) {
	if m.AuctionStart <= 0 {
		return nil, nil
	}
	s := furytime.Format(furytime.UnixNano(m.AuctionStart))
	return &s, nil
}
...
func (r *myMarketDataResolver) AuctionEnd(_ context.Context, m *types.MarketData) (*string, error) {
	...
	s := furytime.Format(furytime.UnixNano(m.AuctionEnd))
	return &s, nil
}
...
func (r *myMarketDataResolver) Timestamp(_ context.Context, m *types.MarketData) (string, error) {
	return furytime.Format(furytime.UnixNano(m.Timestamp)), nil
}
...
func (r *myMarketDataResolver) NextMarkToMarket(_ context.Context, m *types.MarketData) (string, error) {
	return furytime.Format(furytime.UnixNano(m.NextMarkToMarket)), nil
}
...
func (r *myObservableMarketDataResolver) ExtensionTrigger(ctx context.Context, m *types.MarketData) (fury.AuctionTrigger, error) {
...
type myMarketDepthResolver FuryResolverRoot
...
type myMarketDepthUpdateResolver FuryResolverRoot
