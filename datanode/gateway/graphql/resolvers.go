...
import (
	...
	"github.com/elysiumstation/fury/datanode/gateway"
	...
	data "github.com/elysiumstation/fury/protos/fury/data/v1"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/elysiumstation/fury/datanode/gateway/graphql CoreProxyServiceClient,TradingDataServiceClientV2
...
type protocolUpgradeProposalResolver FuryResolverRoot
...
type coreDataSnapshotResolver FuryResolverRoot
...
func (r *coreDataSnapshotResolver) FuryCoreVersion(ctx context.Context, obj *eventspb.CoreSnapshotData) (string, error) {
	return obj.CoreVersion, nil
}

type epochRewardSummaryResolver FuryResolverRoot

func (r *epochRewardSummaryResolver) RewardType(_ context.Context, obj *fury.EpochRewardSummary) (fury.AccountType, error) {
...
func (r *epochRewardSummaryResolver) Epoch(_ context.Context, obj *fury.EpochRewardSummary) (int, error) {
	return int(obj.Epoch), nil
}

type transactionResultResolver FuryResolverRoot
...
type accountUpdateResolver FuryResolverRoot
...
type aggregatedLedgerEntriesResolver FuryResolverRoot

func (r *FuryResolverRoot) AggregatedLedgerEntry() AggregatedLedgerEntryResolver {
	return (*aggregatedLedgerEntriesResolver)(r)
}

func (r *aggregatedLedgerEntriesResolver) FuryTime(_ context.Context, obj *v2.AggregatedLedgerEntry) (int64, error) {
	return obj.Timestamp, nil
}

// LiquidityOrderReference resolver.

type myLiquidityOrderReferenceResolver FuryResolverRoot
...
type myDepositResolver FuryResolverRoot
...
func (r *myDepositResolver) CreatedTimestamp(_ context.Context, obj *types.Deposit) (string, error) {
	...
	return furytime.Format(furytime.UnixNano(obj.CreatedTimestamp)), nil
}
...
func (r *myDepositResolver) CreditedTimestamp(_ context.Context, obj *types.Deposit) (*string, error) {
	...
	t := furytime.Format(furytime.UnixNano(obj.CreditedTimestamp))
	return &t, nil
}

// BEGIN: Query Resolver

type myQueryResolver FuryResolverRoot
...
func (r *myQueryResolver) LastBlockHeight(ctx context.Context) (string, error) {
	resp, err := r.tradingProxyClient.LastBlockHeight(ctx, &furyprotoapi.LastBlockHeightRequest{})
	if err != nil {
		return "0", err
	}
...
func (r *myQueryResolver) EstimateOrder(
	...
	size string,
	side fury.Side,
	timeInForce fury.Order_TimeInForce,
	expiration *int64,
	ty fury.Order_Type,
) (*OrderEstimate, error) {
	order := &types.Order{}
	...
	if order.TimeInForce == types.Order_TIME_IN_FORCE_GTT && expiration != nil {
		order.ExpiresAt = furytime.UnixNano(*expiration).UnixNano()
	}
...
func (r *myQueryResolver) ProposalsConnection(ctx context.Context, proposalType *v2.ListGovernanceDataRequest_Type, inState *fury.Proposal_State,
	pagination *v2.Pagination,
...
func (r *myQueryResolver) Statistics(ctx context.Context) (*furyprotoapi.Statistics, error) {
	req := &furyprotoapi.StatisticsRequest{}
...
type myNodeSignatureResolver FuryResolverRoot
...
type myPartyResolver FuryResolverRoot
...
func (r *myPartyResolver) ProposalsConnection(ctx context.Context, party *types.Party, proposalType *v2.ListGovernanceDataRequest_Type, inState *fury.Proposal_State,
	pagination *v2.Pagination,
) (*v2.GovernanceDataConnection, error) {
...
type myMarginLevelsUpdateResolver FuryResolverRoot
...
type myMarginLevelsResolver FuryResolverRoot
...
type myOrderUpdateResolver FuryResolverRoot
...
func (r *myOrderUpdateResolver) ExpiresAt(_ context.Context, obj *types.Order) (*string, error) {
	...
	expiresAt := furytime.Format(furytime.UnixNano(obj.ExpiresAt))
	return &expiresAt, nil
}

func (r *myOrderUpdateResolver) RejectionReason(_ context.Context, o *types.Order) (*fury.OrderError, error) {
	return o.Reason, nil
}

// BEGIN: Order Resolver

type myOrderResolver FuryResolverRoot

func (r *myOrderResolver) RejectionReason(_ context.Context, o *types.Order) (*fury.OrderError, error) {
	return o.Reason, nil
}
...
type myTradeResolver FuryResolverRoot
...
type myCandleResolver FuryResolverRoot
...
type myDataSourceSpecConfigurationResolver FuryResolverRoot
...
type myPriceLevelResolver FuryResolverRoot
...
type positionUpdateResolver FuryResolverRoot
...
type myPositionResolver FuryResolverRoot
...
type mySubscriptionResolver FuryResolverRoot
...
func (r *mySubscriptionResolver) Candles(ctx context.Context, market string, interval fury.Interval) (<-chan *v2.Candle, error) {
...
type myAccountDetailsResolver FuryResolverRoot
...
type myAccountResolver FuryResolverRoot
...
type myAccountEventResolver FuryResolverRoot

func (r *myAccountEventResolver) Balance(ctx context.Context, acc *fury.Account) (string, error) {
	return acc.Balance, nil
}

func (r *myAccountEventResolver) Market(ctx context.Context, acc *fury.Account) (*types.Market, error) {
	if acc.MarketId == "" {
		return nil, nil
	}
	return r.r.getMarketByID(ctx, acc.MarketId)
...
func (r *myAccountEventResolver) Party(ctx context.Context, acc *fury.Account) (*types.Party, error) {
	if acc.Owner == "" {
		return nil, nil
	}
	return getParty(ctx, r.log, r.r.clt2, acc.Owner)
...
func (r *myAccountEventResolver) Asset(ctx context.Context, obj *fury.Account) (*types.Asset, error) {
	return r.r.getAssetByID(ctx, obj.Asset)
}
...
type myPropertyKeyResolver FuryResolverRoot
