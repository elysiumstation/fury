...
import (
	...
	gql "github.com/elysiumstation/fury/datanode/gateway/graphql"
	"github.com/elysiumstation/fury/datanode/gateway/rest"
	libhttp "github.com/elysiumstation/fury/libs/http"
...
func New(cfg gateway.Config, log *logging.Logger, furyPaths paths.Paths) *Server {
...
func (srv *Server) Start(ctx context.Context) error {
	...
	if srv.cfg.GraphQL.Enabled {
		var err error
		srv.gql, err = gql.New(srv.log, *srv.cfg, srv.furyPaths)
		if err != nil {
			return err
		}
	...
	if srv.cfg.REST.Enabled {
		srv.rest = rest.NewProxyServer(srv.log, *srv.cfg, srv.furyPaths)
	...
	tlsConfig, fallback, err := gateway.GenerateTlsConfig(srv.cfg, srv.furyPaths)
	if err != nil {
