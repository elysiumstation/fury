...
import (
	...
	protoapiv2 "github.com/elysiumstation/fury/protos/data-node/api/v2"
...
func NewProxyServer(log *logging.Logger, config gateway.Config, furyPaths paths.Paths) *ProxyServer {
	// setup logger
...
func (s *ProxyServer) Start(ctx context.Context) (http.Handler, error) {
	...
	if err := furyprotoapi.RegisterCoreServiceHandlerFromEndpoint(ctx, mux, grpcAddr, opts); err != nil {
