...
// Candle constructs a field with the given FURY candle proto value.
func Candle(c fmt.Stringer) zap.Field {
	return zap.String("candle", c.String())
}

// CandleWithTag constructs a field with the given FURY candle proto value and key equal to the tag string.
func CandleWithTag(c fmt.Stringer, tag string) zap.Field {
	return zap.String(tag, c.String())
}

// Order constructs a field with the given FURY order value.
func Order(o fmt.Stringer) zap.Field {
	return zap.String("order", o.String())
}

// ProtoOrder constructs a field with the given FURY order proto value.
...
// OrderWithTag constructs a field with the given FURY order proto value and key equal to the tag string.
func OrderWithTag(o fmt.Stringer, tag string) zap.Field {
	return zap.String(tag, o.String())
}

// Trade constructs a field with the given FURY trade proto value.
func Trade(t fmt.Stringer) zap.Field {
	return zap.String("trade", t.String())
}

// Market constructs a field with the given FURY market proto value.
...
// Party constructs a field with the given FURY party proto value.
...
// Account constructs a field with the given FURY account proto value.
func Account(a fmt.Stringer) zap.Field {
	return zap.String("account", a.String())
}

// ProtoAccount constructs a field with the given FURY account proto value.
