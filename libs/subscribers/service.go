...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/broker_mocks.go -package mocks github.com/elysiumstation/fury/libs/subscribers Broker
