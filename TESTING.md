...
```go
//go:generate go run github.com/golang/mock/mockgen -destination mocks/candle_store_mock.go -package mocks github.com/elysiumstation/fury/candles CandleStore
...
```bash
cd .../go/src/fury/candles # trading-core
rm -rf mocks
go generate .
