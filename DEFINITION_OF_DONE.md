...
## Fury Core Team Definition of Done

**Before merging**
- Create relevant for [system-test](https://github.com/elysiumstation/system-tests/issues) tickets with feature labels (should be done when starting the work)
...
- Create [front end](https://github.com/elysiumstation/token-frontend/issues) or [console](https://github.com/elysiumstation/console/issues) tickets with feature labels (should be done when starting the work if dependencies known i.e. API changes)
...
- Create [documentation](https://github.com/elysiumstation/documentation/issues) tickets with feature labels if functionality has changed, or is a new feature
