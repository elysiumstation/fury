...
// ETHClient ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/eth_client_mock.go -package mocks github.com/elysiumstation/fury/core/client/eth ETHClient
...
func Dial(ctx context.Context, cfg Config) (*Client, error) {
	if len(cfg.RPCEndpoint) <= 0 {
		return nil, errors.New("no ethereum rpc endpoint configured. the configuration have move from the NodeWallet section to the Ethereum section, please make sure your fury configuration is up to date")
	}
