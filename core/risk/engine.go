...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/elysiumstation/fury/core/risk Orderbook,AuctionState,TimeService,StateVarEngine,Model
