...
// Source: github.com/elysiumstation/fury/core/risk (interfaces: Orderbook,AuctionState,TimeService,StateVarEngine,Model)
...
func (m *MockOrderbook) GetCloseoutPrice(arg0 uint64, arg1 fury.Side) (*num.Uint, error) {
	m.ctrl.T.Helper()
