...
type ValidatorTopology interface {
	Len() int
	IsValidatorFuryPubKey(pk string) bool
	IsValidatorNodeID(nodeID string) bool
	AllFuryPubKeys() []string
	IsValidator() bool
