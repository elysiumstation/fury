...
import (
	...
	"github.com/elysiumstation/fury/core/examples/nullchain/config"
	...
	v1 "github.com/elysiumstation/fury/protos/fury/commands/v1"
	datav1 "github.com/elysiumstation/fury/protos/fury/data/v1"
						...
						Changes: &fury.NewMarketConfiguration{
							Instrument: &fury.InstrumentConfiguration{
								...
								Product: &fury.InstrumentConfiguration_Future{
									Future: &fury.FutureProduct{
										SettlementAsset: asset,
										QuoteName:       "BTCUSD",
										DataSourceSpecForSettlementData: &fury.DataSourceDefinition{
											SourceType: &fury.DataSourceDefinition_External{
												External: &fury.DataSourceDefinitionExternal{
													SourceType: &fury.DataSourceDefinitionExternal_Oracle{
														Oracle: &fury.DataSourceSpecConfiguration{
										...
										DataSourceSpecForTradingTermination: &fury.DataSourceDefinition{
											SourceType: &fury.DataSourceDefinition_External{
												External: &fury.DataSourceDefinitionExternal{
													SourceType: &fury.DataSourceDefinitionExternal_Oracle{
														Oracle: &fury.DataSourceSpecConfiguration{
							...
							RiskParameters: &fury.NewMarketConfiguration_Simple{
								Simple: &fury.SimpleModelParams{
									FactorLong:           0.15,
									FactorShort:          0.25,
									MaxMoveUp:            10,
									MinMoveDown:          -5,
...
func VoteTxn(proposalID string, vote fury.Vote_Value) *walletpb.SubmitTransactionRequest {
	return &walletpb.SubmitTransactionRequest{
...
func OrderTxn(
	...
	cmd := &walletpb.SubmitTransactionRequest_OrderSubmission{
		OrderSubmission: &v1.OrderSubmission{
			...
			Side:        side,
			Type:        orderT,
			TimeInForce: fury.Order_TIME_IN_FORCE_GTT,
