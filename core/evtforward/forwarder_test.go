...
import (
	...
	"github.com/elysiumstation/fury/core/evtforward/mocks"
...
var (
	testSelfFuryPubKey = "self-pubkey"
...
func getTestEvtFwd(t *testing.T) *testEvtFwd {
	...
	top.EXPECT().SelfNodeID().AnyTimes().Return(testSelfFuryPubKey)
