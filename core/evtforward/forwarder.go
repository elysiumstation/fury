...
import (
	...
	vgproto "github.com/elysiumstation/fury/libs/proto"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/time_service_mock.go -package mocks github.com/elysiumstation/fury/core/evtforward TimeService
type TimeService interface {
	GetTimeNow() time.Time
}

//go:generate go run github.com/golang/mock/mockgen -destination mocks/commander_mock.go -package mocks github.com/elysiumstation/fury/core/evtforward Commander
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/validator_topology_mock.go -package mocks github.com/elysiumstation/fury/core/evtforward ValidatorTopology
...
// and will try to send them to the fury chain.
