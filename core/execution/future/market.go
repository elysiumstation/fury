...
import (
	...
	liquiditytarget "github.com/elysiumstation/fury/core/liquidity/target"
	...
	lmon "github.com/elysiumstation/fury/core/monitor/liquidity"
	"github.com/elysiumstation/fury/core/monitor/price"
...
// Market represents an instance of a market in fury and is in charge of calling
...
func (m *Market) OnTick(ctx context.Context, t time.Time) bool {
	...
	_, blockHash := furycontext.TraceIDFromContext(ctx)
...
func (m *Market) BlockEnd(ctx context.Context) {
	...
	var tID string
	ctx, tID = furycontext.TraceIDFromContext(ctx)
...
func (m *Market) commandLiquidityAuction(ctx context.Context) {
	...
	if m.as.InAuction() && m.as.CanLeave() && !m.as.IsOpeningAuction() {
		...
		// see  https://github.com/elysiumstation/fury/issues/3047
