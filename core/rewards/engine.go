...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/market_tracker_mock.go -package mocks github.com/elysiumstation/fury/core/rewards MarketActivityTracker
...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/delegation_engine_mock.go -package mocks github.com/elysiumstation/fury/core/rewards Delegation
...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/time_service_mock.go -package mocks github.com/elysiumstation/fury/core/rewards TimeService
type TimeService interface {
	GetTimeNow() time.Time
}

//go:generate go run github.com/golang/mock/mockgen -destination mocks/topology_mock.go -package mocks github.com/elysiumstation/fury/core/rewards Topology
