...
import (
	...
	"github.com/elysiumstation/fury/core/rewards/mocks"
...
func testCalculateRewards(t *testing.T) {
	...
	engine := testEngine.engine
	engine.UpdateAssetForStakingAndDelegation(context.Background(), "FURY")
	...
	rewardAccount, err := testEngine.collateral.GetGlobalRewardAccount("FURY")
...
func testDistributePayout(t *testing.T) {
	...
	partyAccount, err := testEngine.collateral.GetPartyGeneralAccount("party1", "FURY")
	require.Nil(t, err)
...
func testOnEpochEventNoPayoutDelay(t *testing.T) {
	...
	party1Acc, _ := testEngine.collateral.GetPartyGeneralAccount("party1", "FURY")
	party2Acc, _ := testEngine.collateral.GetPartyGeneralAccount("party2", "FURY")
	node1Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node1", "FURY")
	node2Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node2", "FURY")
	node3Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node3", "FURY")
	node4Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node4", "FURY")
