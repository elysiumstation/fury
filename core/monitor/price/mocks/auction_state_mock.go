...
// Source: github.com/elysiumstation/fury/core/monitor/price (interfaces: AuctionState)
...
func (m *MockAuctionState) Mode() fury.Market_TradingMode {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Mode")
	ret0, _ := ret[0].(fury.Market_TradingMode)
	return ret0
}
