...
import (
	...
	"github.com/elysiumstation/fury/core/statevar/mocks"
	types "github.com/elysiumstation/fury/core/types/statevar"
...
func setupValidators(t *testing.T, numValidators int, startCalc func(string, types.FinaliseCalculation), resultCallback func(context.Context, types.StateVariableResult) error) []*testEngine {
	...
	for i, v := range validators {
		...
		v.topology.EXPECT().IsValidatorFuryPubKey(gomock.Any()).DoAndReturn(func(nodeID string) bool {
