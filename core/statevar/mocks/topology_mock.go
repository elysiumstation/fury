...
// Source: github.com/elysiumstation/fury/core/statevar (interfaces: Topology)
...
func (m *MockTopology) IsValidatorFuryPubKey(arg0 string) bool {
	m.ctrl.T.Helper()
...
func (mr *MockTopologyMockRecorder) IsValidatorFuryPubKey(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsValidatorFuryPubKey", reflect.TypeOf((*MockTopology)(nil).IsValidatorFuryPubKey), arg0)
}
