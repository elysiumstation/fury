...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/commander_mock.go -package mocks github.com/elysiumstation/fury/core/statevar Commander
...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/topology_mock.go -package mocks github.com/elysiumstation/fury/core/statevar Topology
type Topology interface {
	IsValidatorFuryPubKey(node string) bool
	AllNodeIDs() []string
