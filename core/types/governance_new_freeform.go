...
func (f ProposalTermsNewFreeform) IntoProto() *furypb.ProposalTerms_NewFreeform {
	var newFreeform *furypb.NewFreeform
	if f.NewFreeform != nil {
		newFreeform = f.NewFreeform.IntoProto()
	}
	return &furypb.ProposalTerms_NewFreeform{
		NewFreeform: newFreeform,
	}
}
...
func NewNewFreeformFromProto(_ *furypb.ProposalTerms_NewFreeform) *ProposalTermsNewFreeform {
	return &ProposalTermsNewFreeform{
		NewFreeform: &NewFreeform{},
	}
}
...
func (n NewFreeform) IntoProto() *furypb.NewFreeform {
	return &furypb.NewFreeform{}
}
