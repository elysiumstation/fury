...
func (a ProposalTermsUpdateMarket) IntoProto() *furypb.ProposalTerms_UpdateMarket {
	return &furypb.ProposalTerms_UpdateMarket{
...
func UpdateMarketFromProto(p *furypb.ProposalTerms_UpdateMarket) (*ProposalTermsUpdateMarket, error) {
...
func (n UpdateMarket) IntoProto() *furypb.UpdateMarket {
	var changes *furypb.UpdateMarketConfiguration
	if n.Changes != nil {
		changes = n.Changes.IntoProto()
	}
	return &furypb.UpdateMarket{
		MarketId: n.MarketID,
		Changes:  changes,
	}
}
...
func (n UpdateMarketConfiguration) IntoProto() *furypb.UpdateMarketConfiguration {
	riskParams := n.RiskParameters.updateRiskParamsIntoProto()
	md := make([]string, 0, len(n.Metadata))
	md = append(md, n.Metadata...)

	var instrument *furypb.UpdateInstrumentConfiguration
	if n.Instrument != nil {
	...
	var liquidityMonitoring *furypb.LiquidityMonitoringParameters
	if n.LiquidityMonitoringParameters != nil {
		liquidityMonitoring = n.LiquidityMonitoringParameters.IntoProto()
	}

	r := &furypb.UpdateMarketConfiguration{
	...
	case *furypb.UpdateMarketConfiguration_Simple:
		r.RiskParameters = rp
	case *furypb.UpdateMarketConfiguration_LogNormal:
		r.RiskParameters = rp
	}
	return r
}

func UpdateMarketConfigurationFromProto(p *furypb.UpdateMarketConfiguration) (*UpdateMarketConfiguration, error) {
...
func (i UpdateInstrumentConfiguration) IntoProto() *furypb.UpdateInstrumentConfiguration {
	p := i.Product.icpIntoProto()
	r := &furypb.UpdateInstrumentConfiguration{
		Code: i.Code,
	}
	switch pr := p.(type) {
	case *furypb.UpdateInstrumentConfiguration_Future:
		r.Product = pr
	}
	return r
}
...
func (i UpdateInstrumentConfigurationFuture) IntoProto() *furypb.UpdateInstrumentConfiguration_Future {
	return &furypb.UpdateInstrumentConfiguration_Future{
		Future: i.Future.IntoProto(),
	}
}

func UpdateInstrumentConfigurationFromProto(p *furypb.UpdateInstrumentConfiguration) *UpdateInstrumentConfiguration {
...
func (f UpdateFutureProduct) IntoProto() *furypb.UpdateFutureProduct {
	return &furypb.UpdateFutureProduct{
...
func (n UpdateMarketConfigurationSimple) IntoProto() *furypb.UpdateMarketConfiguration_Simple {
	return &furypb.UpdateMarketConfiguration_Simple{
		Simple: n.Simple.IntoProto(),
	}
}

func UpdateMarketConfigurationSimpleFromProto(p *furypb.UpdateMarketConfiguration_Simple) *UpdateMarketConfigurationSimple {
	return &UpdateMarketConfigurationSimple{
...
func (n UpdateMarketConfigurationLogNormal) IntoProto() *furypb.UpdateMarketConfiguration_LogNormal {
	return &furypb.UpdateMarketConfiguration_LogNormal{
		LogNormal: n.LogNormal.IntoProto(),
	}
}

func UpdateMarketConfigurationLogNormalFromProto(p *furypb.UpdateMarketConfiguration_LogNormal) *UpdateMarketConfigurationLogNormal {
	return &UpdateMarketConfigurationLogNormal{
		LogNormal: &LogNormalRiskModel{
