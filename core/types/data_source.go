...
func (s *DataSourceDefinitionInternalx) IntoProto() *furypb.DataSourceDefinition_Internal {
	ds := &furypb.DataSourceDefinition_Internal{
	...
	if s.Internal != nil {
		if s.Internal.SourceType != nil {
			...
			case *furypb.DataSourceDefinitionInternal_Time:
				ds = &furypb.DataSourceDefinition_Internal{
					Internal: &furypb.DataSourceDefinitionInternal{
						SourceType: dsn,
					},
...
func (s *DataSourceDefinitionInternalx) String() string {
	if s.Internal != nil {
		...
		// definitions are located in core/fury/protos/ and do not access the local interface
...
// IntoProto returns the proto object from DataSourceDefinitionInternalx
// This method is not called from anywhere.
func (s *DataSourceDefinitionExternalx) IntoProto() *furypb.DataSourceDefinition_External {
	ds := &furypb.DataSourceDefinition_External{
...
func (s *DataSourceDefinitionExternalx) String() string {
	if s.External != nil {
		...
		// definitions are located in core/fury/protos/ and do not access the local intrface
		// and accessing it will lead to cycle import.
...
// that is - furypb.DataSourceDefinition that may have external or internal SourceType.
// Returns the whole proto object.
func (s DataSourceDefinition) IntoProto() *furypb.DataSourceDefinition {
	ds := &furypb.DataSourceDefinition{}

	if s.SourceType != nil {
		switch dsn := s.SourceType.oneOfProto().(type) {
		case *furypb.DataSourceDefinition_External:
			if dsn.External != nil {
		...
		case *furypb.DataSourceDefinition_Internal:
			if dsn.Internal != nil {
...
func DataSourceDefinitionFromProto(protoConfig *furypb.DataSourceDefinition) *DataSourceDefinition {
	if protoConfig != nil {
...
func (s DataSourceDefinition) GetFilters() []*DataSourceSpecFilter {
	...
	if s.SourceType != nil {
		...
		// For the case the definition source type is furypb.DataSourceDefinition_Internal
		case *furypb.DataSourceDefinition_Internal:
			if dsn.Internal != nil {
				if dsn.Internal.SourceType != nil {
					switch idsn := dsn.Internal.SourceType.(type) {
					// For the case the furypb.DataSourceDefinitionInternal is not nill
					// and its embedded object is of type furypb.DataSourceDefinitionInternal_Time
					case *furypb.DataSourceDefinitionInternal_Time:
						...
						// (as of OT https://github.com/elysiumstation/specs/blob/master/protocol/0048-DSRI-data_source_internal.md#13-fury-time-changed)
...
func (s DataSourceDefinition) GetDataSourceSpecConfiguration() *furypb.DataSourceSpecConfiguration {
	if s.SourceType != nil {
		...
		case *furypb.DataSourceDefinitionInternal:
			//
		}
	}

	return &furypb.DataSourceSpecConfiguration{}
}
...
func NewDataSourceDefinition(tp int) *DataSourceDefinition {
	...
	switch tp {
	case furypb.DataSourceDefinitionTypeInt:
	...
	case furypb.DataSourceDefinitionTypeExt:
			...
			if dsn.Internal != nil {
				if dsn.Internal.SourceType != nil {
					...
					case *furypb.DataSourceDefinitionInternal_Time:
						...
						// https://github.com/elysiumstation/specs/blob/master/protocol/0048-DSRI-data_source_internal.md#13-fury-time-changed
						c := []*datapb.Condition{}
						if len(filters) > 0 {
...
func (s *DataSourceDefinition) SetOracleConfig(oc *DataSourceSpecConfiguration) *DataSourceDefinition {
	if s.SourceType != nil {
		...
		// For the case the definition source type is furypb.DataSourceDefinition_External
		case *furypb.DataSourceDefinition_External:
			if def.External != nil {
				if def.External.SourceType != nil {
					switch def.External.SourceType.(type) {
					// For the case the furypb.DataSourceDefinitionExternal is not nill
					// and its embedded object is of type furypb.DataSourceDefinitionExternal_Oracle
					case *furypb.DataSourceDefinitionExternal_Oracle:
...
func (s *DataSourceDefinition) GetDataSourceSpecConfigurationTime() *furypb.DataSourceSpecConfigurationTime {
	if s.SourceType != nil {
		switch tp := s.SourceType.oneOfProto().(type) {
		case *furypb.DataSourceDefinition_Internal:
			if tp.Internal != nil {
