...
func (a ProposalTermsNewAsset) IntoProto() *furypb.ProposalTerms_NewAsset {
	var newAsset *furypb.NewAsset
	if a.NewAsset != nil {
		newAsset = a.NewAsset.IntoProto()
	}
	return &furypb.ProposalTerms_NewAsset{
		NewAsset: newAsset,
	}
}
...
func NewNewAssetFromProto(p *furypb.ProposalTerms_NewAsset) (*ProposalTermsNewAsset, error) {
...
func (n NewAsset) IntoProto() *furypb.NewAsset {
	var changes *furypb.AssetDetails
	if n.Changes != nil {
		changes = n.Changes.IntoProto()
	}
	return &furypb.NewAsset{
		Changes: changes,
	}
}
