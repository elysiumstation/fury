...
func (b DataSourceSpecBindingForFuture) IntoProto() *furypb.DataSourceSpecToFutureBinding {
	return &furypb.DataSourceSpecToFutureBinding{
...
func DataSourceSpecBindingForFutureFromProto(o *furypb.DataSourceSpecToFutureBinding) *DataSourceSpecBindingForFuture {
	return &DataSourceSpecBindingForFuture{
...
func (s *DataSourceSpec) IntoProto() *furypb.DataSourceSpec {
	config := &furypb.DataSourceDefinition{}
	if s.Data != nil {
...
func DataSourceSpecFromProto(specProto *furypb.DataSourceSpec) *DataSourceSpec {
...
func (s *ExternalDataSourceSpec) IntoProto() *furypb.ExternalDataSourceSpec {
...
func ExternalDataSourceSpecFromProto(specProto *furypb.ExternalDataSourceSpec) *ExternalDataSourceSpec {
