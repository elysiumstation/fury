...
func (a ProposalTermsNewMarket) IntoProto() *furypb.ProposalTerms_NewMarket {
	return &furypb.ProposalTerms_NewMarket{
...
func NewNewMarketFromProto(p *furypb.ProposalTerms_NewMarket) (*ProposalTermsNewMarket, error) {
...
func (n NewMarket) IntoProto() *furypb.NewMarket {
	var changes *furypb.NewMarketConfiguration
	if n.Changes != nil {
		changes = n.Changes.IntoProto()
	}
	return &furypb.NewMarket{
		Changes: changes,
	}
}
...
func (n NewMarketConfiguration) IntoProto() *furypb.NewMarketConfiguration {
	riskParams := n.RiskParameters.newRiskParamsIntoProto()
	md := make([]string, 0, len(n.Metadata))
	md = append(md, n.Metadata...)

	var instrument *furypb.InstrumentConfiguration
	if n.Instrument != nil {
	...
	r := &furypb.NewMarketConfiguration{
	...
	case *furypb.NewMarketConfiguration_Simple:
		r.RiskParameters = rp
	case *furypb.NewMarketConfiguration_LogNormal:
		r.RiskParameters = rp
	}
	return r
}
...
func NewMarketConfigurationFromProto(p *furypb.NewMarketConfiguration) (*NewMarketConfiguration, error) {
...
func SuccessorConfigFromProto(p *furypb.SuccessorConfiguration) *SuccessorConfig {
...
func (s *SuccessorConfig) IntoProto() *furypb.SuccessorConfiguration {
	return &furypb.SuccessorConfiguration{
...
func (n NewMarketConfigurationSimple) IntoProto() *furypb.NewMarketConfiguration_Simple {
	return &furypb.NewMarketConfiguration_Simple{
...
func NewMarketConfigurationSimpleFromProto(p *furypb.NewMarketConfiguration_Simple) *NewMarketConfigurationSimple {
	return &NewMarketConfigurationSimple{
...
func (n NewMarketConfigurationLogNormal) IntoProto() *furypb.NewMarketConfiguration_LogNormal {
	return &furypb.NewMarketConfiguration_LogNormal{
...
func NewMarketConfigurationLogNormalFromProto(p *furypb.NewMarketConfiguration_LogNormal) *NewMarketConfigurationLogNormal {
	return &NewMarketConfigurationLogNormal{
		LogNormal: &LogNormalRiskModel{
...
func (i InstrumentConfiguration) IntoProto() *furypb.InstrumentConfiguration {
	p := i.Product.icpIntoProto()
	r := &furypb.InstrumentConfiguration{
		Name: i.Name,
		Code: i.Code,
	}
	switch pr := p.(type) {
	case *furypb.InstrumentConfiguration_Future:
		r.Product = pr
	case *furypb.InstrumentConfiguration_Spot:
		r.Product = pr
	}
	return r
}
...
func InstrumentConfigurationFromProto(
	p *furypb.InstrumentConfiguration,
...
func (i InstrumentConfigurationFuture) IntoProto() *furypb.InstrumentConfiguration_Future {
	return &furypb.InstrumentConfiguration_Future{
...
func (f FutureProduct) IntoProto() *furypb.FutureProduct {
	return &furypb.FutureProduct{
