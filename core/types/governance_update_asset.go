...
func (a ProposalTermsUpdateAsset) IntoProto() *furypb.ProposalTerms_UpdateAsset {
	var updateAsset *furypb.UpdateAsset
	if a.UpdateAsset != nil {
		updateAsset = a.UpdateAsset.IntoProto()
	}
	return &furypb.ProposalTerms_UpdateAsset{
		UpdateAsset: updateAsset,
	}
}
...
func NewUpdateAssetFromProto(p *furypb.ProposalTerms_UpdateAsset) (*ProposalTermsUpdateAsset, error) {
...
func (a UpdateAsset) IntoProto() *furypb.UpdateAsset {
	var changes *furypb.AssetDetailsUpdate
	if a.Changes != nil {
		changes = a.Changes.IntoProto()
	}
	return &furypb.UpdateAsset{
		AssetId: a.AssetID,
		Changes: changes,
	}
}
...
func (a AssetDetailsUpdate) IntoProto() *furypb.AssetDetailsUpdate {
	r := &furypb.AssetDetailsUpdate{
	...
	switch s := src.(type) {
	case *furypb.AssetDetailsUpdate_Erc20:
		r.Source = s
	}
	return r
}
...
func AssetDetailsUpdateFromProto(p *furypb.AssetDetailsUpdate) (*AssetDetailsUpdate, error) {
	var (
...
func (a AssetDetailsUpdateERC20) IntoProto() *furypb.AssetDetailsUpdate_Erc20 {
	lifetimeLimit := "0"
	...
	return &furypb.AssetDetailsUpdate_Erc20{
		Erc20: &furypb.ERC20Update{
...
func AssetDetailsUpdateERC20FromProto(p *furypb.AssetDetailsUpdate_Erc20) (*AssetDetailsUpdateERC20, error) {
	var (
