...
func (i *DataSourceDefinitionInternal) IntoProto() interface{} {
	ds := &furypb.DataSourceDefinitionInternal{}
...
func DataSourceDefinitionInternalFromProto(protoConfig *furypb.DataSourceDefinitionInternal) *DataSourceDefinitionInternal {
