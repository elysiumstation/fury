...
func (a ProposalTermsNewSpotMarket) IntoProto() *furypb.ProposalTerms_NewSpotMarket {
	return &furypb.ProposalTerms_NewSpotMarket{
...
func NewNewSpotMarketFromProto(p *furypb.ProposalTerms_NewSpotMarket) (*ProposalTermsNewSpotMarket, error) {
...
func (n NewSpotMarket) IntoProto() *furypb.NewSpotMarket {
	var changes *furypb.NewSpotMarketConfiguration
	if n.Changes != nil {
		changes = n.Changes.IntoProto()
	}
	return &furypb.NewSpotMarket{
		Changes: changes,
	}
}
...
func (n NewSpotMarketConfiguration) IntoProto() *furypb.NewSpotMarketConfiguration {
	...
	var targetStakeParameters *furypb.TargetStakeParameters
	if n.TargetStakeParameters != nil {
		targetStakeParameters = n.TargetStakeParameters.IntoProto()
	}

	r := &furypb.NewSpotMarketConfiguration{
	...
	case *furypb.NewSpotMarketConfiguration_Simple:
		r.RiskParameters = rp
	case *furypb.NewSpotMarketConfiguration_LogNormal:
		r.RiskParameters = rp
	}
	return r
}
...
func NewSpotMarketConfigurationFromProto(p *furypb.NewSpotMarketConfiguration) (*NewSpotMarketConfiguration, error) {
...
func (n NewSpotMarketConfigurationSimple) IntoProto() *furypb.NewSpotMarketConfiguration_Simple {
	return &furypb.NewSpotMarketConfiguration_Simple{
...
func NewSpotMarketConfigurationSimpleFromProto(p *furypb.NewSpotMarketConfiguration_Simple) *NewSpotMarketConfigurationSimple {
...
func (n NewSpotMarketConfigurationLogNormal) IntoProto() *furypb.NewSpotMarketConfiguration_LogNormal {
	return &furypb.NewSpotMarketConfiguration_LogNormal{
...
func NewSpotMarketConfigurationLogNormalFromProto(p *furypb.NewSpotMarketConfiguration_LogNormal) *NewSpotMarketConfigurationLogNormal {
	return &NewSpotMarketConfigurationLogNormal{
		LogNormal: &LogNormalRiskModel{
...
func (i InstrumentConfigurationSpot) IntoProto() *furypb.InstrumentConfiguration_Spot {
	return &furypb.InstrumentConfiguration_Spot{
...
func (f SpotProduct) IntoProto() *furypb.SpotProduct {
	return &furypb.SpotProduct{
