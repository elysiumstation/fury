...
func OracleSpecConfigurationFromProto(protoConfig *furypb.DataSourceSpecConfiguration) *OracleSpecConfiguration {
...
func OracleSpecBindingForFutureFromProto(o *furypb.DataSourceSpecToFutureBinding) *DataSourceSpecBindingForFuture {
...
func OracleSpecFromProto(specProto *furypb.OracleSpec) *OracleSpec {
