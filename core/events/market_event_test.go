...
func changeOracleSpec(spec *types.DataSourceSpec) {
	...
	spec.Status = furypb.DataSourceSpec_STATUS_UNSPECIFIED
}
...
func TestMarketDeepClone(t *testing.T) {
	...
	pme := furypb.Market{
		Id: "Id",
		TradableInstrument: &furypb.TradableInstrument{
			Instrument: &furypb.Instrument{
				Id:   "Id",
				Code: "Code",
				Name: "Name",
				Metadata: &furypb.InstrumentMetadata{
					Tags: []string{"Tag1", "Tag2"},
				},
				Product: &furypb.Instrument_Future{
					Future: &furypb.Future{
						SettlementAsset: "Asset",
						QuoteName:       "QuoteName",
						DataSourceSpecForSettlementData: &furypb.DataSourceSpec{
							Id:        "Id",
							CreatedAt: 1000,
							UpdatedAt: 2000,
						...
						DataSourceSpecForTradingTermination: &furypb.DataSourceSpec{
							Id:        "Id2",
							CreatedAt: 1000,
							UpdatedAt: 2000,
							Data: &furypb.DataSourceDefinition{
						...
						DataSourceSpecBinding: &furypb.DataSourceSpecToFutureBinding{
			...
			MarginCalculator: &furypb.MarginCalculator{
				ScalingFactors: &furypb.ScalingFactors{
					SearchLevel:       123.45,
					InitialMargin:     234.56,
					CollateralRelease: 345.67,
				},
			},
			RiskModel: &furypb.TradableInstrument_SimpleRiskModel{
				SimpleRiskModel: &furypb.SimpleRiskModel{
					Params: &furypb.SimpleModelParams{
						FactorLong:           123.45,
						FactorShort:          234.56,
						MaxMoveUp:            345.67,
						MinMoveDown:          456.78,
		...
		DecimalPlaces: 5,
		Fees: &furypb.Fees{
			Factors: &furypb.FeeFactors{
				MakerFee:          "0.1",
				InfrastructureFee: "0.2",
				LiquidityFee:      "0.3",
			},
		},
		OpeningAuction: &furypb.AuctionDuration{
			Duration: 1000,
			Volume:   2000,
		},
		PriceMonitoringSettings: &furypb.PriceMonitoringSettings{
			Parameters: &furypb.PriceMonitoringParameters{
				Triggers: []*furypb.PriceMonitoringTrigger{
					{
						Horizon:          1000,
						Probability:      "123.45",
		...
		LiquidityMonitoringParameters: &furypb.LiquidityMonitoringParameters{
			TargetStakeParameters: &furypb.TargetStakeParameters{
				TimeWindow:    1000,
				ScalingFactor: 2.0,
			},
		...
		TradingMode: furypb.Market_TRADING_MODE_CONTINUOUS,
		State:       furypb.Market_STATE_ACTIVE,
		MarketTimestamps: &furypb.MarketTimestamps{
			Proposed: 1000,
			Pending:  2000,
			Open:     3000,
			Close:    4000,
	...
	me.TradingMode = furypb.Market_TRADING_MODE_UNSPECIFIED
	me.State = furypb.Market_STATE_UNSPECIFIED
