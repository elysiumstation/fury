...
func NewProtocolUpgradeProposalEvent(ctx context.Context, upgradeBlockHeight uint64, furyReleaseTag string, acceptedBy []string, status eventspb.ProtocolUpgradeProposalStatus) *ProtocolUpgradeProposalEvent {
...
func (pup ProtocolUpgradeProposalEvent) Proto() eventspb.ProtocolUpgradeEvent {
	return eventspb.ProtocolUpgradeEvent{
		FuryReleaseTag:     pup.FuryReleaseTag,
...
func ProtocolUpgradeProposalEventFromStream(ctx context.Context, be *eventspb.BusEvent) *ProtocolUpgradeProposalEvent {
	...
	return &ProtocolUpgradeProposalEvent{
		...
		FuryReleaseTag:     event.FuryReleaseTag,
