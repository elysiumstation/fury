...
func NewOracleSpecEvent(ctx context.Context, spec furypb.OracleSpec) *OracleSpec {
	cpy := spec.DeepClone()
	return &OracleSpec{
...
func (o *OracleSpec) OracleSpec() furypb.OracleSpec {
	return o.o
}

func (o OracleSpec) Proto() furypb.OracleSpec {
	return o.o
}
