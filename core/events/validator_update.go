...
func NewValidatorUpdateEvent(
	...
	return &ValidatorUpdate{
		...
		furyPubKeyIndex: furyPubKeyIndex,
...
// FuryPublicKey returns validator's fury public key.
func (vu ValidatorUpdate) FuryPublicKey() string {
	return vu.furyPubKey
}

// FuryPublicKey returns validator's fury public key index.
func (vu ValidatorUpdate) FuryPublicKeyIndex() uint32 {
	return vu.furyPubKeyIndex
}
...
func (vu ValidatorUpdate) Proto() eventspb.ValidatorUpdate {
	return eventspb.ValidatorUpdate{
		NodeId:          vu.nodeID,
		FuryPubKey:      vu.furyPubKey,
		FuryPubKeyIndex: vu.furyPubKeyIndex,
...
func ValidatorUpdateEventFromStream(ctx context.Context, be *eventspb.BusEvent) *ValidatorUpdate {
	...
	return &ValidatorUpdate{
		...
		furyPubKey:      event.GetFuryPubKey(),
		furyPubKeyIndex: event.GetFuryPubKeyIndex(),
