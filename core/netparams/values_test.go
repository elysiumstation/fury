...
func TestJSONVPriceMonitoringParameters(t *testing.T) {
	...
	j := netparams.NewJSON(&fury.PriceMonitoringParameters{}, netparams.PriceMonitoringParametersValidation).Mutable(true).MustUpdate(validPmJSONString)
	assert.NotNil(t, j)
	...
	pm := &fury.PriceMonitoringParameters{}
