...
var StakingMetaData = &bind.MetaData{
	ABI: "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"fury_public_key\",\"type\":\"bytes32\"}],\"name\":\"Stake_Deposited\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"fury_public_key\",\"type\":\"bytes32\"}],\"name\":\"Stake_Removed\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"from\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"to\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"fury_public_key\",\"type\":\"bytes32\"}],\"name\":\"Stake_Transferred\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"staking_token\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"target\",\"type\":\"address\"},{\"internalType\":\"bytes32\",\"name\":\"fury_public_key\",\"type\":\"bytes32\"}],\"name\":\"stake_balance\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"total_staked\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
//
// Solidity: function stake_balance(address target, bytes32 fury_public_key) view returns(uint256)
func (_Staking *StakingCaller) StakeBalance(opts *bind.CallOpts, target common.Address, fury_public_key [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _Staking.contract.Call(opts, &out, "stake_balance", target, fury_public_key)
	if err != nil {
...
//
// Solidity: function stake_balance(address target, bytes32 fury_public_key) view returns(uint256)
func (_Staking *StakingSession) StakeBalance(target common.Address, fury_public_key [32]byte) (*big.Int, error) {
	return _Staking.Contract.StakeBalance(&_Staking.CallOpts, target, fury_public_key)
}

// StakeBalance is a free data retrieval call binding the contract method 0x274abf34.
//
// Solidity: function stake_balance(address target, bytes32 fury_public_key) view returns(uint256)
func (_Staking *StakingCallerSession) StakeBalance(target common.Address, fury_public_key [32]byte) (*big.Int, error) {
	return _Staking.Contract.StakeBalance(&_Staking.CallOpts, target, fury_public_key)
}
...
//
// Solidity: event Stake_Deposited(address indexed user, uint256 amount, bytes32 indexed fury_public_key)
func (_Staking *StakingFilterer) FilterStakeDeposited(opts *bind.FilterOpts, user []common.Address, fury_public_key [][32]byte) (*StakingStakeDepositedIterator, error) {
	var userRule []interface{}
	for _, userItem := range user {
		userRule = append(userRule, userItem)
	}

	var fury_public_keyRule []interface{}
	for _, fury_public_keyItem := range fury_public_key {
		fury_public_keyRule = append(fury_public_keyRule, fury_public_keyItem)
	}

	logs, sub, err := _Staking.contract.FilterLogs(opts, "Stake_Deposited", userRule, fury_public_keyRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Stake_Deposited(address indexed user, uint256 amount, bytes32 indexed fury_public_key)
func (_Staking *StakingFilterer) WatchStakeDeposited(opts *bind.WatchOpts, sink chan<- *StakingStakeDeposited, user []common.Address, fury_public_key [][32]byte) (event.Subscription, error) {
	var userRule []interface{}
	for _, userItem := range user {
		userRule = append(userRule, userItem)
	}
	...
	logs, sub, err := _Staking.contract.WatchLogs(opts, "Stake_Deposited", userRule, fury_public_keyRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Stake_Removed(address indexed user, uint256 amount, bytes32 indexed fury_public_key)
func (_Staking *StakingFilterer) FilterStakeRemoved(opts *bind.FilterOpts, user []common.Address, fury_public_key [][32]byte) (*StakingStakeRemovedIterator, error) {
	var userRule []interface{}
	for _, userItem := range user {
		userRule = append(userRule, userItem)
	}
	...
	logs, sub, err := _Staking.contract.FilterLogs(opts, "Stake_Removed", userRule, fury_public_keyRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Stake_Removed(address indexed user, uint256 amount, bytes32 indexed fury_public_key)
func (_Staking *StakingFilterer) WatchStakeRemoved(opts *bind.WatchOpts, sink chan<- *StakingStakeRemoved, user []common.Address, fury_public_key [][32]byte) (event.Subscription, error) {
	var userRule []interface{}
	for _, userItem := range user {
		userRule = append(userRule, userItem)
	}
	...
	logs, sub, err := _Staking.contract.WatchLogs(opts, "Stake_Removed", userRule, fury_public_keyRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event Stake_Transferred(address indexed from, uint256 amount, address indexed to, bytes32 indexed fury_public_key)
func (_Staking *StakingFilterer) FilterStakeTransferred(opts *bind.FilterOpts, from []common.Address, to []common.Address, fury_public_key [][32]byte) (*StakingStakeTransferredIterator, error) {
	...
	logs, sub, err := _Staking.contract.FilterLogs(opts, "Stake_Transferred", fromRule, toRule, fury_public_keyRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Stake_Transferred(address indexed from, uint256 amount, address indexed to, bytes32 indexed fury_public_key)
func (_Staking *StakingFilterer) WatchStakeTransferred(opts *bind.WatchOpts, sink chan<- *StakingStakeTransferred, from []common.Address, to []common.Address, fury_public_key [][32]byte) (event.Subscription, error) {
	var fromRule []interface{}
	for _, fromItem := range from {
		fromRule = append(fromRule, fromItem)
	}
	...
	logs, sub, err := _Staking.contract.WatchLogs(opts, "Stake_Transferred", fromRule, toRule, fury_public_keyRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
