...
import (
	...
	"github.com/elysiumstation/fury/core/assets/builtin"
	"github.com/elysiumstation/fury/core/assets/erc20"
	"github.com/elysiumstation/fury/core/broker"
	"github.com/elysiumstation/fury/core/events"
	nweth "github.com/elysiumstation/fury/core/nodewallets/eth"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/elysiumstation/fury/core/assets ERC20BridgeView,Notary
...
func (s *Service) Enable(ctx context.Context, assetID string) error {
	...
	if asset.IsERC20() {
		eth, _ := asset.ERC20()
		s.ethToFury[eth.ProtoAsset().GetDetails().GetErc20().GetContractAddress()] = assetID
	}
