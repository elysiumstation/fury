...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/chain_mock.go -package mocks github.com/elysiumstation/fury/core/nodewallets Chain
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/blockchain_stats_mock.go -package mocks github.com/elysiumstation/fury/core/nodewallets BlockchainStats
...
func NewCommander(cfg Config, log *logging.Logger, bc Chain, w *fury.Wallet, bstats BlockchainStats) (*Commander, error) {
