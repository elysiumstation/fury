...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/orderbook_mock.go -package mocks github.com/elysiumstation/fury/core/liquidity OrderBook
