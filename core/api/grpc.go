...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/event_service_mock.go -package mocks github.com/elysiumstation/fury/core/api EventService
...
// TimeService ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/time_service_mock.go -package mocks github.com/elysiumstation/fury/core/api TimeService
...
// EvtForwarder
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/evt_forwarder_mock.go -package mocks github.com/elysiumstation/fury/core/api  EvtForwarder
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/blockchain_mock.go -package mocks github.com/elysiumstation/fury/core/api  Blockchain
...
// NewGRPC create a new instance of the GPRC api for the fury node.
func NewGRPC(
	log *logging.Logger,
	config Config,
	stats *stats.Stats,
