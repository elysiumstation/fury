...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/time_service_mock.go -package mocks github.com/elysiumstation/fury/core/pow TimeService
