...
// GetChainVersion returns the version of the chain in use by fury.
func (s *Stats) GetChainVersion() string {
	return s.chainVersion
}

// GetVersion return the version of fury which is currently running.
func (s *Stats) GetVersion() string {
	return s.version
}

// GetVersionHash return the hash of the commit this fury
