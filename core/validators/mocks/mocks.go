...
// Source: github.com/elysiumstation/fury/core/validators (interfaces: NodeWallets,TimeService,Commander,ValidatorTopology,Wallet,ValidatorPerformance,Notary,Signatures,MultiSigTopology)
...
import (
	...
	txn "github.com/elysiumstation/fury/core/txn"
	validators "github.com/elysiumstation/fury/core/validators"
	crypto "github.com/elysiumstation/fury/libs/crypto"
	v1 "github.com/elysiumstation/fury/protos/fury/commands/v1"
	v10 "github.com/elysiumstation/fury/protos/fury/snapshot/v1"
...
// GetFury mocks base method.
func (m *MockNodeWallets) GetFury() validators.Wallet {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFury")
	ret0, _ := ret[0].(validators.Wallet)
	return ret0
}

// GetFury indicates an expected call of GetFury.
func (mr *MockNodeWalletsMockRecorder) GetFury() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFury", reflect.TypeOf((*MockNodeWallets)(nil).GetFury))
}
...
// AllFuryPubKeys mocks base method.
func (m *MockValidatorTopology) AllFuryPubKeys() []string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllFuryPubKeys")
	ret0, _ := ret[0].([]string)
	return ret0
}

// AllFuryPubKeys indicates an expected call of AllFuryPubKeys.
func (mr *MockValidatorTopologyMockRecorder) AllFuryPubKeys() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllFuryPubKeys", reflect.TypeOf((*MockValidatorTopology)(nil).AllFuryPubKeys))
}
...
// IsValidatorFuryPubKey mocks base method.
func (m *MockValidatorTopology) IsValidatorFuryPubKey(arg0 string) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsValidatorFuryPubKey", arg0)
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsValidatorFuryPubKey indicates an expected call of IsValidatorFuryPubKey.
func (mr *MockValidatorTopologyMockRecorder) IsValidatorFuryPubKey(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsValidatorFuryPubKey", reflect.TypeOf((*MockValidatorTopology)(nil).IsValidatorFuryPubKey), arg0)
}

// SelfFuryPubKey mocks base method.
func (m *MockValidatorTopology) SelfFuryPubKey() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SelfFuryPubKey")
	ret0, _ := ret[0].(string)
	return ret0
}

// SelfFuryPubKey indicates an expected call of SelfFuryPubKey.
func (mr *MockValidatorTopologyMockRecorder) SelfFuryPubKey() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelfFuryPubKey", reflect.TypeOf((*MockValidatorTopology)(nil).SelfFuryPubKey))
}
