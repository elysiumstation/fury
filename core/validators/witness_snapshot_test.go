...
func TestSnapshot(t *testing.T) {
	...
	erc2.top.EXPECT().SelfFuryPubKey().AnyTimes().Return("1234")
	...
	erc2.top.EXPECT().IsValidatorFuryPubKey(pubkey.Hex()).Times(1).Return(true)
	...
	erc3.top.EXPECT().SelfFuryPubKey().AnyTimes().Return("1234")
