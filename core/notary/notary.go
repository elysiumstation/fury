...
// ValidatorTopology...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/validator_topology_mock.go -package mocks github.com/elysiumstation/fury/core/notary ValidatorTopology
type ValidatorTopology interface {
	IsValidator() bool
	IsValidatorFuryPubKey(string) bool
	IsTendermintValidator(string) bool
	SelfFuryPubKey() string
	Len() int
}
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/commander_mock.go -package mocks github.com/elysiumstation/fury/core/notary Commander
