...
import (
	...
	"github.com/elysiumstation/fury/core/blockchain/nullchain"
	"github.com/elysiumstation/fury/core/bridges"
	...
	"github.com/elysiumstation/fury/core/netparams/checks"
	"github.com/elysiumstation/fury/core/netparams/dispatch"
	...
	"github.com/elysiumstation/fury/core/oracles/adaptors"
	oracleAdaptors "github.com/elysiumstation/fury/core/oracles/adaptors"
...
func newServices(
	...
	svcs.timeService = furytime.New(svcs.conf.Time, svcs.broker)
	...
	if svcs.conf.IsValidator() {
		...
		svcs.commander, err = nodewallets.NewCommander(
			svcs.conf.NodeWallet, svcs.log, blockchainClient, nodeWallets.Fury, svcs.stats)
		if err != nil {
			return nil, err
		}
	}
	...
	svcs.snapshot, err = snapshot.New(svcs.ctx, svcs.furyPaths, svcs.conf.Snapshot, svcs.log, svcs.timeService, svcs.stats.Blockchain)
	if err != nil {
