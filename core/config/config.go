...
import (
	...
	"github.com/elysiumstation/fury/core/client/eth"
	"github.com/elysiumstation/fury/core/collateral"
	cfgencoding "github.com/elysiumstation/fury/core/config/encoding"
	"github.com/elysiumstation/fury/core/coreapi"
	"github.com/elysiumstation/fury/core/delegation"
	"github.com/elysiumstation/fury/core/epochtime"
	...
	"github.com/elysiumstation/fury/core/governance"
	"github.com/elysiumstation/fury/core/limits"
	"github.com/elysiumstation/fury/core/metrics"
	"github.com/elysiumstation/fury/core/netparams"
	"github.com/elysiumstation/fury/core/nodewallets"
	"github.com/elysiumstation/fury/core/notary"
	"github.com/elysiumstation/fury/core/oracles"
	"github.com/elysiumstation/fury/core/pow"
	"github.com/elysiumstation/fury/core/processor"
	"github.com/elysiumstation/fury/core/protocolupgrade"
	"github.com/elysiumstation/fury/core/rewards"
	"github.com/elysiumstation/fury/core/snapshot"
	"github.com/elysiumstation/fury/core/spam"
	"github.com/elysiumstation/fury/core/staking"
	"github.com/elysiumstation/fury/core/statevar"
	"github.com/elysiumstation/fury/core/stats"
	"github.com/elysiumstation/fury/core/validators"
	"github.com/elysiumstation/fury/core/validators/erc20multisig"
...
type Config struct {
	...
	Time              furytime.Config        `group:"Time" namespace:"time"`
	...
	NodeMode         cfgencoding.NodeMode `long:"mode" description:"The mode of the fury node [validator, full]"`
	MaxMemoryPercent uint8                `long:"max-memory-percent" description:"The maximum amount of memory reserved for the fury node (default: 33%)"`
}

// NewDefaultConfig returns a set of default configs for all fury packages, as specified at the per package
...
func NewDefaultConfig() Config {
	return Config{
		...
		Time:              furytime.NewDefaultConfig(),
...
func InitialiseLoader(furyPaths paths.Paths) (*Loader, error) {
	configFilePath, err := furyPaths.CreateConfigPathFor(paths.NodeDefaultConfigFile)
	if err != nil {
