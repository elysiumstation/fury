...
//
// Solidity: function get_asset_source(bytes32 fury_asset_id) view returns(address)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedCaller) GetAssetSource(opts *bind.CallOpts, fury_asset_id [32]byte) (common.Address, error) {
	var out []interface{}
	err := _Erc20BridgeLogicRestricted.contract.Call(opts, &out, "get_asset_source", fury_asset_id)
...
//
// Solidity: function get_asset_source(bytes32 fury_asset_id) view returns(address)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedSession) GetAssetSource(fury_asset_id [32]byte) (common.Address, error) {
	return _Erc20BridgeLogicRestricted.Contract.GetAssetSource(&_Erc20BridgeLogicRestricted.CallOpts, fury_asset_id)
}

// GetAssetSource is a free data retrieval call binding the contract method 0x786b0bc0.
//
// Solidity: function get_asset_source(bytes32 fury_asset_id) view returns(address)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedCallerSession) GetAssetSource(fury_asset_id [32]byte) (common.Address, error) {
	return _Erc20BridgeLogicRestricted.Contract.GetAssetSource(&_Erc20BridgeLogicRestricted.CallOpts, fury_asset_id)
}
...
// GetFuryAssetId is a free data retrieval call binding the contract method 0xa06b5d39.
//
// Solidity: function get_fury_asset_id(address asset_source) view returns(bytes32)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedCaller) GetFuryAssetId(opts *bind.CallOpts, asset_source common.Address) ([32]byte, error) {
	var out []interface{}
	err := _Erc20BridgeLogicRestricted.contract.Call(opts, &out, "get_fury_asset_id", asset_source)
...
//
// Solidity: function get_fury_asset_id(address asset_source) view returns(bytes32)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedSession) GetFuryAssetId(asset_source common.Address) ([32]byte, error) {
	return _Erc20BridgeLogicRestricted.Contract.GetFuryAssetId(&_Erc20BridgeLogicRestricted.CallOpts, asset_source)
}

// GetFuryAssetId is a free data retrieval call binding the contract method 0xa06b5d39.
//
// Solidity: function get_fury_asset_id(address asset_source) view returns(bytes32)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedCallerSession) GetFuryAssetId(asset_source common.Address) ([32]byte, error) {
	return _Erc20BridgeLogicRestricted.Contract.GetFuryAssetId(&_Erc20BridgeLogicRestricted.CallOpts, asset_source)
}
...
//
// Solidity: function deposit_asset(address asset_source, uint256 amount, bytes32 fury_public_key) returns()
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedTransactor) DepositAsset(opts *bind.TransactOpts, asset_source common.Address, amount *big.Int, fury_public_key [32]byte) (*types.Transaction, error) {
	return _Erc20BridgeLogicRestricted.contract.Transact(opts, "deposit_asset", asset_source, amount, fury_public_key)
}

// DepositAsset is a paid mutator transaction binding the contract method 0xf7683932.
//
// Solidity: function deposit_asset(address asset_source, uint256 amount, bytes32 fury_public_key) returns()
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedSession) DepositAsset(asset_source common.Address, amount *big.Int, fury_public_key [32]byte) (*types.Transaction, error) {
	return _Erc20BridgeLogicRestricted.Contract.DepositAsset(&_Erc20BridgeLogicRestricted.TransactOpts, asset_source, amount, fury_public_key)
}

// DepositAsset is a paid mutator transaction binding the contract method 0xf7683932.
//
// Solidity: function deposit_asset(address asset_source, uint256 amount, bytes32 fury_public_key) returns()
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedTransactorSession) DepositAsset(asset_source common.Address, amount *big.Int, fury_public_key [32]byte) (*types.Transaction, error) {
	return _Erc20BridgeLogicRestricted.Contract.DepositAsset(&_Erc20BridgeLogicRestricted.TransactOpts, asset_source, amount, fury_public_key)
}
...
//
// Solidity: function list_asset(address asset_source, bytes32 fury_asset_id, uint256 lifetime_limit, uint256 withdraw_threshold, uint256 nonce, bytes signatures) returns()
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedTransactor) ListAsset(opts *bind.TransactOpts, asset_source common.Address, fury_asset_id [32]byte, lifetime_limit *big.Int, withdraw_threshold *big.Int, nonce *big.Int, signatures []byte) (*types.Transaction, error) {
	return _Erc20BridgeLogicRestricted.contract.Transact(opts, "list_asset", asset_source, fury_asset_id, lifetime_limit, withdraw_threshold, nonce, signatures)
}

// ListAsset is a paid mutator transaction binding the contract method 0x0ff3562c.
//
// Solidity: function list_asset(address asset_source, bytes32 fury_asset_id, uint256 lifetime_limit, uint256 withdraw_threshold, uint256 nonce, bytes signatures) returns()
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedSession) ListAsset(asset_source common.Address, fury_asset_id [32]byte, lifetime_limit *big.Int, withdraw_threshold *big.Int, nonce *big.Int, signatures []byte) (*types.Transaction, error) {
	return _Erc20BridgeLogicRestricted.Contract.ListAsset(&_Erc20BridgeLogicRestricted.TransactOpts, asset_source, fury_asset_id, lifetime_limit, withdraw_threshold, nonce, signatures)
}

// ListAsset is a paid mutator transaction binding the contract method 0x0ff3562c.
//
// Solidity: function list_asset(address asset_source, bytes32 fury_asset_id, uint256 lifetime_limit, uint256 withdraw_threshold, uint256 nonce, bytes signatures) returns()
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedTransactorSession) ListAsset(asset_source common.Address, fury_asset_id [32]byte, lifetime_limit *big.Int, withdraw_threshold *big.Int, nonce *big.Int, signatures []byte) (*types.Transaction, error) {
	return _Erc20BridgeLogicRestricted.Contract.ListAsset(&_Erc20BridgeLogicRestricted.TransactOpts, asset_source, fury_asset_id, lifetime_limit, withdraw_threshold, nonce, signatures)
}
...
//
// Solidity: event Asset_Deposited(address indexed user_address, address indexed asset_source, uint256 amount, bytes32 fury_public_key)
...
//
// Solidity: event Asset_Listed(address indexed asset_source, bytes32 indexed fury_asset_id, uint256 nonce)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedFilterer) FilterAssetListed(opts *bind.FilterOpts, asset_source []common.Address, fury_asset_id [][32]byte) (*Erc20BridgeLogicRestrictedAssetListedIterator, error) {

	var asset_sourceRule []interface{}
	for _, asset_sourceItem := range asset_source {
		asset_sourceRule = append(asset_sourceRule, asset_sourceItem)
	}
	var fury_asset_idRule []interface{}
	for _, fury_asset_idItem := range fury_asset_id {
		fury_asset_idRule = append(fury_asset_idRule, fury_asset_idItem)
	}

	logs, sub, err := _Erc20BridgeLogicRestricted.contract.FilterLogs(opts, "Asset_Listed", asset_sourceRule, fury_asset_idRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Asset_Listed(address indexed asset_source, bytes32 indexed fury_asset_id, uint256 nonce)
func (_Erc20BridgeLogicRestricted *Erc20BridgeLogicRestrictedFilterer) WatchAssetListed(opts *bind.WatchOpts, sink chan<- *Erc20BridgeLogicRestrictedAssetListed, asset_source []common.Address, fury_asset_id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Erc20BridgeLogicRestricted.contract.WatchLogs(opts, "Asset_Listed", asset_sourceRule, fury_asset_idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
