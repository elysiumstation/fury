...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/elysiumstation/fury/core/governance Markets,StakingAccounts,Assets,TimeService,Witness,NetParams
