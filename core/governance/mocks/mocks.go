...
// Source: github.com/elysiumstation/fury/core/governance (interfaces: Markets,StakingAccounts,Assets,TimeService,Witness,NetParams)
...
import (
	...
	netparams "github.com/elysiumstation/fury/core/netparams"
...
func (m *MockMarkets) GetMarketState(arg0 string) (fury.Market_State, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMarketState", arg0)
	ret0, _ := ret[0].(fury.Market_State)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
