...
import (
	...
	amocks "github.com/elysiumstation/fury/core/assets/mocks"
	...
	emocks "github.com/elysiumstation/fury/core/execution/common/mocks"
...
func getNodeWallet() *nodewallets.NodeWallets {
	...
	nw, _ := nodewallets.GetNodeWallets(config, furyPaths, registryPass)
	return nw
}
