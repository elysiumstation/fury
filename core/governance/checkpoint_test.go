...
func marshalProposal(t *testing.T, proposal *furypb.Proposal) []byte {
	t.Helper()
	proposals := &checkpointpb.Proposals{
		Proposals: []*furypb.Proposal{proposal},
	}
