...
func GenerateWallet(furyPaths paths.Paths, passphrase string) (*WalletGenerationResult, error) {
	ctx := context.Background()

	walletsHome, err := furyPaths.CreateDataDirFor(paths.FaucetWalletsDataHome)
	if err != nil {
...
func loadWallet(furyPaths paths.Paths, walletName, passphrase string) (*faucetWallet, error) {
	ctx := context.Background()
