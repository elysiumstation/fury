...
import (
	...
	vghttp "github.com/elysiumstation/fury/libs/http"
...
func NewService(log *logging.Logger, furyPaths paths.Paths, cfg Config, passphrase string) (*Faucet, error) {
	log = log.Named(namedLogger)
	log.SetLevel(cfg.Level.Level)

	wallet, err := loadWallet(furyPaths, cfg.WalletName, passphrase)
	if err != nil {
