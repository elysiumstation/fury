Feature: Short close-out test (see ln 449 of system-tests/grpc/trading/tradesTests.py & https://github.com/elysiumstation/scenario-runner/tree/develop/scenarios/QA/issues/86)
