...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/time_service_mock.go -package mocks github.com/elysiumstation/fury/core/collateral TimeService
...
func (e *Engine) EnableAsset(ctx context.Context, asset types.Asset) error {
	...
	if _, ok := e.accs[externalID]; !ok {
		...
		// see https://github.com/elysiumstation/fury/pull/2745 for more information
	...
	rewardAccountTypes := []fury.AccountType{types.AccountTypeGlobalReward}
