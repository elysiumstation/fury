...
func testUpgradeProposalRejected(t *testing.T) {
	...
	require.Equal(t, eventspb.ProtocolUpgradeProposalStatus_PROTOCOL_UPGRADE_PROPOSAL_STATUS_PENDING, evts[0].StreamMessage().GetProtocolUpgradeEvent().Status)
	require.Equal(t, 1, len(evts[0].StreamMessage().GetProtocolUpgradeEvent().Approvers))
	require.Equal(t, "1.0.0", evts[0].StreamMessage().GetProtocolUpgradeEvent().FuryReleaseTag)
	...
	require.Equal(t, "1.0.0", evts[1].StreamMessage().GetProtocolUpgradeEvent().FuryReleaseTag)
	...
	require.Equal(t, "1.0.2", evts[2].StreamMessage().GetProtocolUpgradeEvent().FuryReleaseTag)
	...
	require.Equal(t, "1.0.0", evts[3].StreamMessage().GetProtocolUpgradeEvent().FuryReleaseTag)
	...
	require.Equal(t, "1.0.2", evts[4].StreamMessage().GetProtocolUpgradeEvent().FuryReleaseTag)
...
func testProposalApproved(t *testing.T) {
	...
	require.Equal(t, "1.0.0", evts[2].StreamMessage().GetProtocolUpgradeEvent().FuryReleaseTag)
...
func testMultiProposalApproved(t *testing.T) {
	...
	require.Equal(t, "1.0.1", evts[9].StreamMessage().GetProtocolUpgradeEvent().FuryReleaseTag)
