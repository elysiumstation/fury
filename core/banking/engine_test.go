...
import (
	...
	"github.com/elysiumstation/fury/core/banking/mocks"
...
func testDepositSuccess(t *testing.T) {
	...
	// to do the deposit
	eng.col.EXPECT().Deposit(gomock.Any(), bad.PartyID, bad.FuryAssetID, bad.Amount).Times(1).Return(&types.LedgerMovement{}, nil)
