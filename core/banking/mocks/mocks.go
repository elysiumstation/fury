...
// Source: github.com/elysiumstation/fury/core/banking (interfaces: Assets,Notary,Collateral,Witness,TimeService,EpochService,Topology,MarketActivityTracker,ERC20BridgeView,EthereumEventSource)
...
func (m *MockCollateral) TransferFunds(arg0 context.Context, arg1 []*types.Transfer, arg2 []fury.AccountType, arg3 []string, arg4 []*types.Transfer, arg5 []fury.AccountType) ([]*types.LedgerMovement, error) {
	m.ctrl.T.Helper()
...
func (m *MockMarketActivityTracker) GetMarketScores(arg0 string, arg1 []string, arg2 fury.DispatchMetric) []*types.MarketContributionScore {
	m.ctrl.T.Helper()
