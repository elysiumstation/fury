...
func testHDKeyPairNewKeyPairSucceeds(t *testing.T) {
	...
	assert.Equal(t, "fury/ed25519", kp.AlgorithmName())
...
func testHDKeyPairMarshalingKeyPairSucceeds(t *testing.T) {
	...
	expected := fmt.Sprintf(`{"index":1,"public_key":"%s","private_key":"%s","meta":null,"tainted":false,"algorithm":{"name":"fury/ed25519","version":1}}`, testPublicKey, testPrivateKey)
...
func testHDKeyPairUnmarshalingKeyPairSucceeds(t *testing.T) {
	// given
	kp := wallet.HDKeyPair{}
	marshalled := fmt.Sprintf(`{"index":1,"public_key":"%s","private_key":"%s","meta":null,"tainted":false,"algorithm":{"name":"fury/ed25519","version":1}}`, testPublicKey, testPrivateKey)
