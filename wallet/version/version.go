...
import (
	...
	vgversion "github.com/elysiumstation/fury/libs/version"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/store_mock.go -package mocks github.com/elysiumstation/fury/wallet/version NetworkStore
