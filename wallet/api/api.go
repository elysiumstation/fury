...
// Generates mocks
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/elysiumstation/fury/wallet/api WalletStore,NetworkStore,Interactor,ConnectionsManager,SpamHandler
