...
import (
	...
	"github.com/elysiumstation/fury/wallet/api/node/adapters"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/node_mock.go -package mocks github.com/elysiumstation/fury/wallet/api/node GRPCAdapter
...
func (n *RetryingNode) Statistics(ctx context.Context) (nodetypes.Statistics, error) {
	...
	n.log.Debug("response from Statistics",
		...
		zap.String("fury-time", resp.FuryTime),
