...
func testImportNetworkWithURL(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:       "real-url",
			url:        "https://github.com/elysiumstation/networks-internal/blob/main/fairground/furywallet-fairground.toml",
			suggestion: "https://raw.githubusercontent.com/elysiumstation/networks-internal/main/fairground/furywallet-fairground.toml",
		...
		},
		{
			...
			url:        "https://github.com/elysiumstation/fury/issues",
			jsonrpcErr: jsonrpc.ErrorCodeInternalError,
		},
	}
