...
import (
	...
	nodeapi "github.com/elysiumstation/fury/wallet/api/node"
	"github.com/elysiumstation/fury/wallet/api/spam"
	"github.com/elysiumstation/fury/wallet/network"
	"github.com/elysiumstation/fury/wallet/node"
	...
	walletversion "github.com/elysiumstation/fury/wallet/version"
	"github.com/elysiumstation/fury/wallet/wallets"
	"go.uber.org/zap"
)

//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/elysiumstation/fury/wallet/service NetworkStore
