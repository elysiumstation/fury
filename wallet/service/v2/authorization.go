...
// It is our non-standard scheme that stands for Fury Wallet Token.
const VWTPrefix = "VWT"

// VWT stands for Fury Wallet Token. It has the following format:
//
//	VWT <TOKEN>
//
// Example:
...
// ExtractVWT extracts the Fury Wallet Token from the `Authorization` header.
