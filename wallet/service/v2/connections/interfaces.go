...
// Generates mocks
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/elysiumstation/fury/wallet/service/v2/connections WalletStore,TimeService,TokenStore,SessionStore
