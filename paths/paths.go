...
// FuryHome is the name of the Fury folder for every type of file structure.
var FuryHome = "fury"
...
var (
	...
	// FuryNodeWalletsDataHome is the folder containing the fury wallet
	// used by the node.
	FuryNodeWalletsDataHome = DataPath(filepath.Join(NodeWalletsDataHome.String(), "fury"))
